    ...
    <div class="offset3 span3">
        <form class="form-horizontal" id="searchForm" method="post">
            <div class="control-group">
                ...
                <div class="controls">
                    ...
                    createCombo("SELECT s.stockpile_id, s.stockpile_name, CONCAT(s.stockpile_code, ' - ', s.stockpile_name) AS stockpile_full
                                ...
                                ORDER BY s.stockpile_id ASC, s.stockpile_name ASC", "", "", "stockpileId", "stockpile_name", "stockpile_full", 
			...
			<div class="control-group">
                ...
                <div class="controls">
                     <?php
						createCombo("", "", "", "vendorFreightId", "vendor_id", "vendor_freight", "", 1, "select2combobox100", 1, "");
					?>
                </div>
            </div>
            <div class="control-group">

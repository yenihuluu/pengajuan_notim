...
//            alert('tes');
            ...
            $('#dataContent').load('reports/paymentDP-report.php', {
...
GROUP BY vendor_name ORDER BY vendor_name ASC", "", "", "generalVendorId", "vendor_name", "vendor_name", "", 1, "select2combobox100", 7, "multiple");
					?>
                </div>
            </div>
			<div class="control-group">

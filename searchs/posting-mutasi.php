...
<script type="text/javascript">
    $(document).ready(function(){
        ...
        $('#searchForm').submit(function(e){
            e.preventDefault();
//            alert('tes');
			if($('select[id="mutasiHeaderId"]').val() != '') {
            $('#dataContent').load('reports/posting-mutasi.php', {
    ...
    <div class="offset3 span3">
        <form class="form-horizontal" id="searchForm" method="post">
            <div class="control-group">
                <label class="control-label" for="mutasiHeaderId">Kode Mutasi<span style="color: red;">*</span></label>
                <div class="controls">
                    <?php
                    createCombo("select mutasi_header_id, kode_mutasi from mutasi_header where status = 1 order by kode_mutasi ", "", "", "mutasiHeaderId", "mutasi_header_id", "kode_mutasi",

...
<script type="text/javascript">
    $(document).ready(function(){
        $('#searchForm').submit(function(e){
            e.preventDefault();
//            alert('tes');
            $('#dataContent').load('reports/sales-collection-report.php', {
                stockpileId: $('select[id="searchStockpileId"]').val(), 
                customerId: $('select[id="searchCustomerId"]').val(), 
...
<div class="row" style="background-color: #f5f5f5; 
    ...
    <div class="offset3 span3">
        <form class="form-horizontal" id="searchForm" method="post">
            ...
            <div class="control-group">
                <label class="control-label" for="searchCustomerId">Customer</label>
                <div class="controls">
                    <?php 
                    createCombo("SELECT DISTINCT cust.customer_id, cust.customer_name
                                ...
                                WHERE 1=1", "", "", "searchCustomerId", "customer_id", "customer_name", 
                                "", 3, "", 7);
                    ?>
                </div>
            </div>

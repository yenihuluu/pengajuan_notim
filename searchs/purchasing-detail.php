...
//            alert('tes');
            ...
            $('#dataContent').load('reports/purchasing-detail.php', {
...
<div class="row" style="background-color: #f5f5f5;
    ...
    <div class="offset3 span3">
        <form method="post" action="print_purchasing_detail.php" target="_blank">

            <div class="control-group">
                <label class="control-label" for="stockpileId">Stockpile</label>
                <div class="controls">
                    <?php

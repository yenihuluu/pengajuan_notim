    ...
    <div class="offset3 span3">
        <form class="form-horizontal" id="searchForm" method="post">
            ...
            <div class="control-group">
                <label class="control-label" for="glModule">Periode</label>
                <div class="controls">
                    <?php 
                    createCombo("SELECT SUBSTR(period,1,4) AS period FROM pl_period GROUP BY SUBSTR(period,1,4) ", "", "", "period", "period", "period", "", "", "", 1);

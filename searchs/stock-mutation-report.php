...
function createCombo($sql, $setvalue = "", $disabled = "", $id = "", $valuekey = "", $value = "", $uniq = "", $tabindex = "", $class = "", $empty = 1, $onchange = "", $boolAllow = false)
{
    ...
    if ($empty == 1) {
        ...
        echo "<option value='all'>All Stockpiles</option>";
    }
    if ($result !== false) {
            ...
            <div class="control-group">
                ...
                <div class="controls">
                    ...
                    createCombo("SELECT s.stockpile_id, CONCAT(s.stockpile_code, ' - ', s.stockpile_name) AS stockpile_full
                        ...
                        "", 7, "select2combobox100", 3, "multiple");
                    ?>
                </div>
            </div>
            <div class="control-group">
                ...
                <div class="controls">
                    <input type="text" placeholder="DD/MM/YYYY" tabindex="2" id="searchPeriodFrom"
                           name="searchPeriodFrom" data-date-format="dd/mm/yyyy" class="datepicker">
                </div>
            </div>
            <div class="control-group">
                <label class="control-label" for="searchPeriodTo">Period To</label>
                <div class="controls">
                    <input type="text" placeholder="DD/MM/YYYY" tabindex="3" id="searchPeriodTo" name="searchPeriodTo"

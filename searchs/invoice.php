...
//            alert('tes');
            ...
            $('#dataContent').load('contents/invoice.php', {
                invoice: $('input[id="invoice"]').val(), 
    ...
    <div class="offset3 span3">
        <form class="form-horizontal" id="searchForm" method="post">
            <div class="control-group">
                <label class="control-label" for="invoice">Invoice No</label>
                <div class="controls">
                   <input type="text" class="span3" tabindex="18" id="invoice" name="invoice" value="">
                </div>

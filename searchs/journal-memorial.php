...
//            alert('tes');
            ...
            $('#dataContent').load('contents/journal-memorial.php', {
    ...
    <div class="offset3 span3">
        <form class="form-horizontal" id="searchForm" method="post">
            <div class="control-group">
                <label class="control-label" for="invoice">Jurnal No</label>
                <div class="controls">
                   <input type="text" class="span3" tabindex="18" id="jurnalNo" name="jurnalNo" value="">
                </div>

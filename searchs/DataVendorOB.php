...
<script type="text/javascript">
    $(document).ready(function(){
        $('#searchForm').submit(function(e){
            e.preventDefault();
//            alert('tes');
            $('#dataContent').load('reports/dataVendorOB-report.php', {
				labor: $('select[id="labor"]').val(),
        ...
        <form class="form-horizontal" id="searchForm" method="post">
            ...
            <div class="control-group">
                ...
                <div class="controls">
                    ...
                    <?php
						createCombo("SELECT l.labor_id, l.labor_name FROM labor l
						WHERE 1=1 AND l.active = 1 ORDER BY l.labor_id DESC", "", "", "labor", "labor_id", "labor_name", "", 3, "select2combobox300", "", "multiple");
                    ?>

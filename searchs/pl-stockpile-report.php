    ...
    <div class="offset3 span3">
        <form class="form-horizontal" id="searchForm" method="post">
         <div class="control-group">
                ...
                <div class="controls">
                    <?php 
                    createCombo("SELECT DISTINCT(YEAR(b.Date)) AS gl_date FROM gl b WHERE b.Date > 0", "", "", "glDate", "gl_date", "gl_date", "", 7, "", 7);

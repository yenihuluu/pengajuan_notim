...
//            alert('tes');
            $('#dataContent').load('reports/general-ledger-report.php', {
				...
				jurnalNo: $('input[id="jurnalNo"]').val()
...
<div class="row" style="background-color: #f5f5f5; 
    ...
    <div class="offset3 span3">
        <form class="form-horizontal" id="searchForm" method="post">
            ...
            <div class="control-group">
                ...
                <div class="controls">
                   ...
                   createCombo("SELECT 'CONTRACT' AS id, 'CONTRACT' AS info UNION
								...
								SELECT 'INVOICE NOTIM' AS id, 'INVOICE NOTIM' AS info UNION
                                ...
                                SELECT 'JURNAL ACCRUE' AS id, 'JURNAL ACCRUE' AS info UNION
                                SELECT 'RETURN ACCRUE' AS id, 'RETURN ACCRUE' AS info UNION
								SELECT 'RETURN INVOICE' AS id, 'RETURN INVOICE' AS info UNION
								SELECT 'RETURN INVOICE NOTIM' AS id, 'RETURN INVOICE NOTIM' AS info UNION
			...
			<div class="control-group">
                <label class="control-label" for="jurnalNo">Jurnal No</label>
                <div class="controls">
                  <input type="text"  id="jurnalNo" name="jurnalNo" />
                </div>
            </div>
            <div class="control-group">
                <div class="controls">

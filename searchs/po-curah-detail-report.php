    ...
    $(document).ready(function(){
		...
		$('#searchVendorId').change(function() {
            ...
            if(document.getElementById('searchVendorId').value != '') {
                resetPONo(' ');
                setPONo($('select[id="searchVendorId"]').val(), 0);
            }
        });
	});
    ...
    <div class="offset3 span3">
        <form class="form-horizontal" id="searchForm" method="post">
            ...
            <div class="control-group">
                ...
                <div class="controls">
                    <?php 
                    createCombo("SELECT DISTINCT v.vendor_id AS vendor_id, v.vendor_name AS vendor_name, con.contract_type
                    FROM vendor v
                    LEFT JOIN contract con
                        ON con.vendor_id = v.vendor_id
                    LEFT JOIN stockpile_contract sc
                        ON sc.contract_id = con.contract_id
                    WHERE 1=1 AND con.contract_type = 'C' GROUP BY v.vendor_name", "", "", "searchVendorId", "vendor_id", "vendor_name", 

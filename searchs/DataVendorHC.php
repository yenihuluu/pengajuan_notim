...
<script type="text/javascript">
    $(document).ready(function(){
        $('#searchForm').submit(function(e){
            e.preventDefault();
//            alert('tes');
            	$('#dataContent').load('reports/dataVendorHC-report.php', {
				vendorHandling: $('select[id="vendorHandling"]').val(),
            ...
            <div class="control-group">
                ...
                <div class="controls">
                    ...
                    createCombo("SELECT s.stockpile_id, CONCAT(s.stockpile_code, ' - ', s.stockpile_name) AS stockpile_full
                                ...
                                "", "", "select2combobox300", 7, "multiple");
                    ?>
                </div>
            </div>
            <div class="control-group">
                <label class="control-label" for="vendorHandling">Vendor Handling</label>
                <div class="controls">
                   
                    <?php
						createCombo("SELECT vh.vendor_handling_id, CONCAT(vh.vendor_handling_code, ' - ', vh.vendor_handling_name) AS vendor_handling_full FROM vendor_handling vh
WHERE 1=1 AND vh.`active` = 1 ORDER BY vh.vendor_handling_id DESC", "", "", "vendorHandling", "vendor_handling_id", "vendor_handling_full", "", 3, "select2combobox300", 7, "multiple");
                    ?>
			...
			<div class="control-group">
                ...
                <div class="controls">
                    ...
                    createCombo("SELECT '1' AS id, 'Active' AS info UNION
                                SELECT '0' AS id, 'Inactive' AS info ", "", "", "searchStatus", "id", "info", 
                                "", 7, "", 7);
                    ?>
                </div>
            </div>

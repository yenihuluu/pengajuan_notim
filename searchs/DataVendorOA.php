...
<script type="text/javascript">
    $(document).ready(function(){
        $('#searchForm').submit(function(e){
            e.preventDefault();
//            alert('tes');
            	$('#dataContent').load('reports/dataVendorOA-report.php', {
				freightSupplier: $('select[id="freightSupplier"]').val(),
...
<div class="row" style="background-color: #f5f5f5; 
    ...
    <div class="offset3 span3">
        <form class="form-horizontal" id="searchForm" method="post">
            ...
            <div class="control-group">
                <label class="control-label" for="freightSupplier">Freight Supplier</label>
                <div class="controls">
                   
                    <?php
						createCombo("SELECT f.freight_id, CONCAT(f.freight_code, ' - ', f.freight_supplier) AS freight_full FROM freight f
						WHERE 1=1 AND f.active = 1 ORDER BY f.freight_id DESC", "", "", "freightSupplier", "freight_id", "freight_full", "", 3, "select2combobox300", 7, "multiple");
                    ?>

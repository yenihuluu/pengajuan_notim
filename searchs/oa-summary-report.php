...
// <editor-fold defaultstate="collapsed" desc="Functions">
 $_SESSION['menu_name'] = 'OA Summary Report';
...
//            alert('tes');
            ...
            $('#dataContent').load('reports/oa-summary-report.php', {
				...
				freightId: $('select[id="freightId"]').val(),
...
<div class="row" style="background-color: #f5f5f5; 
    ...
    <div class="offset3 span3">
        <form class="form-horizontal" id="searchForm" method="post">
			...
			<div class="control-group">
                <label class="control-label" for="searchStockpileId">Vendor OA </label>
                <div class="controls">
                    <?php
						createCombo("", "", "", "freightId", "freight_id", "freight_supplier", "", 1, "select2combobox100", 1 );
					?>
                </div>
            </div>
			<div class="control-group">
                <label class="control-label" for="searchStockpileId">PKS Name</label>
                <div class="controls">
                     <?php
						createCombo("", "", "", "vendorFreightId", "vendor_id", "vendor_freight", "", 1, "select2combobox100", 7, "multiple");
					?>
                </div>
            </div>
            <div class="control-group">

    ...
    <div class="offset3 span3">
        <form class="form-horizontal" id="searchForm" method="post">
            ...
            <div class="control-group">
                ...
                <div class="controls">
                    <?php 
                    createCombo("SELECT DISTINCT v.vendor_id AS vendor_id, v.vendor_name AS vendor_name
                                FROM vendor v
                                INNER JOIN contract con
                                    ON con.vendor_id = v.vendor_id
                                INNER JOIN stockpile_contract sc
                                    ON sc.contract_id = con.contract_id
                                WHERE 1=1 GROUP BY v.vendor_name", "", "", "searchVendorId", "vendor_name", "vendor_name", 

...
//            alert('tes');
            ...
            $('#dataContent').load('reports/po-summary-report.php', {
				...
				rejectStatus: $('select[id="rejectStatus"]').val()
...
<div class="row" style="background-color: #f5f5f5; 
    ...
    <div class="offset3 span3">
        <form class="form-horizontal" id="searchForm" method="post">
            ...
            <div class="control-group">
                <label class="control-label" for="paymentFrom">Payment Date From</label>
                <div class="controls">
                    <input type="text" placeholder="DD/MM/YYYY" tabindex="5" id="paymentFrom" name="paymentFrom" data-date-format="dd/mm/yyyy" class="datepicker" >
                </div>
                
            </div>
            <div class="control-group">
                <label class="control-label" for="paymentTo">Payment Date To</label>
                <div class="controls">
                    <input type="text" placeholder="DD/MM/YYYY" tabindex="6" id="paymentTo" name="paymentTo" data-date-format="dd/mm/yyyy" class="datepicker" >
                </div>
            </div>
              <div class="control-group">
                <label class="control-label" for="searchPeriodFrom">Notim Receive Date From</label>
                <div class="controls">
            ...
            <div class="control-group">
                <label class="control-label" for="searchPeriodTo">Notim Receive Date To</label>
                <div class="controls">
			...
			<div class="control-group">
                <label class="control-label" for="inputFrom">Contrat Input Date From</label>
                <div class="controls">
                    <input type="text" placeholder="DD/MM/YYYY" tabindex="5" id="inputFrom" name="inputFrom" data-date-format="dd/mm/yyyy" class="datepicker" >
                </div>
                
            </div>
            <div class="control-group">
                <label class="control-label" for="inputTo">Contract Input Date To</label>
                <div class="controls">
                    <input type="text" placeholder="DD/MM/YYYY" tabindex="6" id="inputTo" name="inputTo" data-date-format="dd/mm/yyyy" class="datepicker" >
                </div>
            </div>
			<div class="control-group">
                <label class="control-label" for="adjustmentTo">Adjustment Date To</label>
                <div class="controls">
                    <input type="text" placeholder="DD/MM/YYYY" tabindex="6" id="adjustmentTo" name="adjustmentTo" data-date-format="dd/mm/yyyy" class="datepicker" >
                </div>
            </div>
			<?php 
                 if($allowFilter){
			...
			<div class="control-group">
                ...
                <div class="controls">
                    <?php 
                    createCombo("SELECT 'Open' AS id, 'Open' AS info UNION
                                SELECT 'Closed' AS id, 'Closed' AS info UNION
                                SELECT 'Outstanding' AS id, 'Outstanding' AS info", "", "", "searchStatus", "id", "info", 
                                "", 7, "", 7);
                    ?>
                </div>
            </div>
			<?php  } ?>
			<div class="control-group">
                <label class="control-label" for="rejectStatus">Reject Status</label>
                <div class="controls">
                    <?php 
                    createCombo("SELECT '0' AS id, 'OK' AS info UNION
                                SELECT '2' AS id, 'Reject' AS info ", "", "", "rejectStatus", "id", "info", 
                                "", 7, "", 7);
                    ?>
                </div>
            </div>

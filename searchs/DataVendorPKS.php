...
//            alert('tes');
            	...
            	$('#dataContent').load('reports/dataVendorPKS-report.php', {
        ...
        <form class="form-horizontal" id="searchForm" method="post">
            ...
            <div class="control-group">
                ...
                <div class="controls">
                    ...
                    <?php
						createCombo("SELECT v.vendor_id, CONCAT(v.vendor_code, ' - ', v.vendor_name) AS vendor_full FROM vendor v
						WHERE 1=1 AND v.active = 1 ORDER BY v.vendor_id DESC", "", "", "vendorId", "vendor_id", "vendor_full", "", 3, "select2combobox300", 7,"multiple");
                    ?>

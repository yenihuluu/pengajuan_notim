...
<script type="text/javascript">
    $(document).ready(function(){
        $('#searchForm').submit(function(e){
            e.preventDefault();
//            alert('tes');
            	$('#dataContent').load('reports/dataVendor-report.php', {
    ...
    <div class="offset3 span3">
        <form class="form-horizontal" id="searchForm" method="post">
            ...
            <div class="control-group">
                <label class="control-label" for="freightSupplier">Vendor</label>
                <div class="controls">
                   
                    <?php
						createCombo("SELECT gv.general_vendor_id, gv.general_vendor_name FROM general_vendor gv
						WHERE 1=1 AND gv.active = 1 ORDER BY gv.general_vendor_id DESC", "", "", "vendorId", "general_vendor_id", "general_vendor_name", "", 3, "select2combobox300", 7,"multiple");
                    ?>

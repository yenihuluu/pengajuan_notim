...
//            alert('tes');
            ...
            $('#dataContent').load('reports/po-summary-report-admin.php', {
    ...
    <div class="offset3 span3">
        <form class="form-horizontal" id="searchForm" method="post">
        	<div class="control-group">
                ...
                <div class="controls">
                    <?php 
                    createCombo("SELECT DISTINCT v.vendor_name                 
								FROM vendor v
                                LEFT JOIN contract con
                                    ON con.vendor_id = v.vendor_id
                                LEFT JOIN stockpile_contract sc
                                    ON sc.contract_id = con.contract_id
                                WHERE 1=1 AND v.active = 1", "", "", "searchVendorId", "vendor_id", "vendor_name", 
			...
			<div class="control-group">
                <label class="control-label" for="inputFrom">Input Date From</label>
                <div class="controls">
            ...
            <div class="control-group">
                <label class="control-label" for="inputTo">Input Date To</label>
                <div class="controls">

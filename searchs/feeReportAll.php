    ...
    <div class="offset3 span3">
        <form class="form-horizontal" id="searchForm" method="post">
            <div class="control-group">
				...
				<div class="control-group">
                <label class="control-label" for="searchStockpile">Vendor</label>
                <div class="controls">
                    <?php 
                    createCombo("SELECT vendor_id, vendor_name FROM vendor WHERE active = 1 ORDER BY vendor_name ASC", "", "", "vendorId", "vendor_id", "vendor_name", 
                                "", "", "", 7);
                    ?>
                </div>
            </div>

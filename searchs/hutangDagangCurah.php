...
<script type="text/javascript">
    $(document).ready(function(){
		...
		$('#searchForm').submit(function(e){
            e.preventDefault();
//            alert('tes');
			 //if($('select[id="searchVendorId"]').val() !== '' && $('select[id="searchVendorId"]').val() !== 'NULL') {
			...
			<label class="control-label" for="searchStockpileId">Stockpile <span style="color: red;">*</span></label>
                <div class="controls">
                    ...
                    createCombo("SELECT s.stockpile_code, CONCAT(s.stockpile_code, ' - ', s.stockpile_name) AS stockpile_full
                                ...
                                ORDER BY s.stockpile_id ASC, s.stockpile_name ASC", "", "", "stockpileId", "stockpile_code", "stockpile_full", 
                                "", 1, "select2combobox100", 1, "multiple");
                    ?>
                </div>
            </div>
            <div class="control-group">

...
//            alert('tes');
            ...
            $('#dataContent').load('reports/complete-report-admin.php', {
    ...
    <div class="offset3 span3">
        <form class="form-horizontal" id="searchForm" method="post">
            ...
            <div class="control-group">
                ...
                <div class="controls">
                    <?php
						createCombo("SELECT freight_id AS vendor_id, freight_supplier AS vendor_name, active FROM freight
WHERE freight_supplier IS NOT NULL
GROUP BY vendor_name ORDER BY vendor_name ASC", "", "", "searchVendorId", "vendor_id", "vendor_name", "", 3, "select2combobox100", "", "multiple");
                    ?>
                </div>
            </div>
            <div class="control-group">

...
//            alert('tes');
            ...
            $('#dataContent').load('reports/arusUang-report.php', {
    ...
    <div class="offset3 span3">
        <form class="form-horizontal" id="searchForm" method="post">
            ...
            <div class="control-group">
				...
				<div class="control-group">
                <label class="control-label" for="searchPeriodTo1">Period</label>
                <div class="controls">
                    <input type="text" placeholder="MM/YYYY" tabindex="" id="period" name="period" data-date-format="mm/yyyy" class="datepicker2" >
                </div>
            </div>   
            <div class="control-group">
                <div class="controls">

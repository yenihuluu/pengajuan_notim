...
function setSlipFreight_1($stockpileId_1, $freightId_1, $contractFreight, $checkedSlips, $ppn, $pph, $paymentFromFP, $paymentToFP, $idPP)
{
    ...
    $sql = "SELECT  {$selectPaymentOA} sc.stockpile_id, f.freight_rule, txpph.tax_id AS pph_tax_id, 
...
function setSlipFreight_settle($stockpileId, $freightId, $settle, $contractFreight, $checkedSlips, $checkedSlipsDP, $ppn, $pph, $paymentFrom, $paymentTo, $idPP, $validation) {
    global $myDatabase;
    $returnValue = '';
	$whereProperty = '';
    $return_val = '';
    ...
    if($validation == 1){
        $selectedSettle = "disabled='disabled";
    }

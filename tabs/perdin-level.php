                ...
                $.ajax({
                    ...
                    success: function(data) {
                        ...
                        if (parseInt(returnVal[4]) != 0)	//if no errors
                        {
                            ...
                            if (returnVal[1] == 'OK') {
                                document.getElementById('generalLevelId').value = returnVal[3];
                                
                                $('#dataContent').load('forms/perdin-level.php', { levelId: returnVal[3] }, iAmACallbackFunction2);
...
<form method="post" id="levelDataForm">
    <input type="hidden" name="action" id="action" value="perdin_level_data" />
    <input type="hidden" name="levelId" id="levelId" value="<?php echo $levelId; ?>" />
    <div class="row-fluid">  
        <div class="span4 lightblue">
            <label>Level Name <span style="color: red;">*</span></label>
            <input type="text" class="span12" tabindex="3" id="level" name="level" value="<?php echo $level; ?>">
        </div>
        <div class="span4 lightblue">

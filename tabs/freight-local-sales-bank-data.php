...
if(isset($_POST['freightId']) && $_POST['freightId'] != '') {
    ...
    //            alert($('#addNew').attr('href'));
                $('#addFreightBankModalForm').load('forms/freight-local-sales-bank.php', {freightId: $('input[id="generalFreightId"]').val()});
            });
    ...
    //                        alert(data);
                            if(parseInt(returnVal[3])!=0)	//if no errors
                            {
                                ...
                                if(returnVal[1] == 'OK') {
                                    ...
                                    $('#freight-local-sales-bank-data').load('tabs/freight-local-sales-bank-data.php', {freightId: $('input[id="modalFreightId"]').val()});
            ...
            $('#tabContent2').load('contents/freight-local-sales-bank.php', { freightId: <?php echo $freightId; ?> }, iAmACallbackFunction2);
    ...
    <div id="addFreightBankModal" class="modal hide fade" tabindex="-1" role="dialog" aria-labelledby="addFreightBankModalLabel" aria-hidden="true">
        <form id="addFreightBankForm" method="post" style="margin: 0px;">
            ...
            <input type="hidden" name="action" id="action" value="freight_local_sales_bank_data" />

...
<script type="text/javascript">
    ...
    function getVendorBank(type, vendorId, bankId) {
        $.ajax({
            url: 'get_data.php',
            method: 'POST',
            data: {
...
<script type="text/javascript">
    $(function () {
        ...
        getVendorBank(1, <?php echo $generalVendorId ?>, <?php echo $bankId ?> );
        <?php } ?>
...
<form method="POst" id="PODataForm">
    ...
    <div class="row-fluid" style="margin-bottom: 25px;">
        <div class="span4 lightblue">
            ...
            <?php
            createCombo("SELECT general_vendor_id, general_vendor_name
                        FROM general_vendor  WHERE active = 1 ORDER BY general_vendor_name", $generalVendorId, $readonlyProperty, "generalVendorId", "general_vendor_id", "general_vendor_name",

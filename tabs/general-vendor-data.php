...
if($result->num_rows > 0) {
   ...
   // $readonlyProperty = 'readonly';
    ...
    if($resultData !== false && $resultData->num_rows > 0) {
		...
		$nik = $rowData->nik;
        $email = $rowData->general_vendor_email;
                    ...
                    success: function(data) {
                        ...
                        if (parseInt(returnVal[4]) != 0)	//if no errors
                        {
                            ...
                            if (returnVal[1] == 'OK') {
                                ...
                                $('#dataContent').load('contents/general-vendor.php', { vendorId: returnVal[3] }, iAmACallbackFunction2);
...
<form method="post" id="generalVendorDataForm">
    <input type="hidden" name="action" id="action" value="general_vendor_data" />

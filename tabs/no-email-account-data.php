...
// <editor-fold defaultstate="collapsed" desc="Variable for no Email Data">
$accountId = '';
$accountNo = '';
$beneficiary = '';
// </editor-fold>
...
if(isset($_POST['accountId']) && $_POST['accountId'] != '') {
    ...
    // <editor-fold defaultstate="collapsed" desc="Query for no Email Data">
    
    $sql = "SELECT * FROM no_email_account WHERE account_id = {$accountId}";
...
<script type="text/javascript">
    ...
    $(document).ready(function(){
        $("#noEmailAccountForm").validate({
            rules: {
                accountNo: "required",
                beneficiaty: "required"
            },
            messages: {
                accountNo: "Account Number is required",
                beneficiaty: "Beneficiary is required"
            },
            submitHandler: function(form) {
                ...
                $.ajax({
                    ...
                    method: 'POST',
                    data: $("#noEmailAccountForm").serialize(),
                    success: function(data) {
                        ...
                        if (parseInt(returnVal[4]) != 0)	//if no errors
                        {
                            ...
                            if (returnVal[1] == 'OK') {
                                ...
                                $('#dataContent').load('forms/no-email-account-form.php', { accountId: returnVal[3] }, iAmACallbackFunction2);
...
<form method="post" id="noEmailAccountForm">
    <input type="hidden" name="action" id="action" value="no_email_account_data" />
    ...
    <div class="row-fluid">   
        ...
        <div class="span4 lightblue">
            ...
            <input type="text" class="span12" tabindex="2" id="beneficiary" name="beneficiary" value="<?php echo $beneficiary; ?>">
        </div>
    </div>
    <div class="row-fluid">

...
WHERE 1=1 {$whereAvailableProperty} AND t.rsb = 1
...
WHERE 1=1 {$whereAvailableProperty2} AND t.`slip_retur` IS NULL AND t.`notim_status` = 0 AND t.rsb = 1 GROUP BY  SUBSTRING(t.slip_no,1,3)

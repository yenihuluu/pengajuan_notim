...
$fileName = "End Stock Report RSB " . $periodFull . str_replace(" ", "-", $_SESSION['userName']) . " " . date("Ymd-His") . ".xls";
$onSheet = 0;
$lastColumn = "M";
...
WHERE 1=1 {$whereAvailableProperty} AND t.ggl = 0 AND t.rsb = 1

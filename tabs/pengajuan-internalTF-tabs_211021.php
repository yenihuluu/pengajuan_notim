...
<script type="text/javascript">
    $(document).ready(function () {
        ...
        <?php if($internalTF_id != ''){ ?>
			setBankITF(1, <?php echo $stockpileLocation ?>, <?php echo $bankId ?>);
        <?php }else{ ?>
...
<script type="text/javascript">
    $(function () {
        ...
        Object.keys(sessionStorage).forEach((key) => {
            ...
            if (newKey[0] == "pengajuanInternalTF" && newKey[1] != "") {
                document.getElementById(newKey[1]).value = sessionStorage.getItem(key);
                $('#' + newKey[1]).trigger('change');
            }
        });
        $(":input").change(function () {
            sessionStorage.setItem("pengajuanInternalTF." + this.id, this.value);
        });
    });
</script>
<form method="post" id="PengajuanInternalTF_form" enctype="multipart/form-data">
    ...
    <div class="row-fluid">
        ...
        <div class="span3 lightblue">
            ...
            <input type="text" placeholder="DD/MM/YYYY" tabindex="" id="periodeFrom" name="periodeFrom"
                   value="<?php echo $periodeFrom; ?>" data-date-format="dd/mm/yyyy" class="datepicker">
        </div>

        <div class="span3 lightblue">
            <label>Periode To<span style="color: red;">*</span></label>
            <input type="text" placeholder="DD/MM/YYYY" tabindex="" id="periodeTo" value="<?php echo $periodeTo; ?>"
                   name="periodeTo" data-date-format="dd/mm/yyyy" class="datepicker">
        </div>
    </div>
    ...
    <div class="row-fluid">
        <div class="span12 lightblue">
            <label>Catatan</label>
            <textarea class="span12" rows="3" tabindex=""  <?php echo $readonly ?> id="remarks"
    ...
    <div class="row-fluid">
        <div class="span12 lightblue">
            <button class="btn btn-primary" id="submitButton2">Kirim</button>

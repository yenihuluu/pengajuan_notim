    ...
    $(document).ready(function () {
        $('#contentTable a').click(function (e) {
            ...
            if (menu[0] == 'detail') {
                ...
                //$("#modalErrorMsg").hide();
                $('#addDetailModal5').modal('show');
                //            alert($('#addNew').attr('href'));
                $('#addDetailModalForm5').load('forms/detail-endstock-uncertified.php', {
                    period: menu[1],
...
<form method="post" id="downloadxls" action="tabs/endstock_uncertified-xls.php">
...
WHERE 1=1 {$whereAvailableProperty} AND (t.uncertified = 1  OR t.uncertified = 0 OR t.uncertified IS NULL)
...
WHERE 1=1 {$whereAvailableProperty2} AND t.`slip_retur` IS NULL AND t.`notim_status` = 0 AND (t.uncertified = 1  OR t.uncertified = 0 OR t.uncertified IS NULL) GROUP BY  SUBSTRING(t.slip_no,1,3)
...
<div id="addDetailModal5" class="modal hide fade" tabindex="-1" role="dialog" aria-labelledby="detailModalLabel"
     aria-hidden="true" style="width:1000px; height:500px; margin-left:-500px;">
    <form id="detailForm"  method="post" style="margin: 0px;" action="reports/detailEndStock-uncertified-xls.php">
        ...
        <div class="modal-body" id="addDetailModalForm5">

...
if (isset($_POST['idPOHDR']) && $_POST['idPOHDR'] != '') {
    ...
    $requestPaymentDate2 = $_POST['requestPaymentDateValue2'];
            ...
            if (document.getElementById('idPOHDR').value != 0) {
                ...
                $('#dataContent').load('forms/pengajuan-general.php', {
                   ...
                   transaksiOKSAKT: document.getElementById('transaksiOKSAKT').value,
                    ...
                    requestPaymentDateValue2: document.getElementById('requestPaymentDateValue2').value
    ...
    $(function () {
        ...
        $('#paymentType').change(function () {
            ...
            if (this.value == 1) {
                ...
                $('#divrequestPaymentDate').show();
                document.getElementById('requestPaymentDateValue').readOnly = true;
                document.getElementById('requestPaymentDateValue2').readOnly = false;
...
<form method="post" id="PengajuanDataForm" enctype="multipart/form-data">
    ...
    <div class="row-fluid" style="margin-bottom: 10px;">
        ...
        <div class="span3 lightblue" id="divrequestPaymentDate" style="display: none">
            ...
            <input type="text"  name="requestPaymentDate" id="requestPaymentDateValue2"  value="<?php echo $requestPaymentDate2; ?>" disabled>
            <input type="text" placeholder="DD/MM/YYYY" tabindex="" name="requestPaymentDate1" id="requestPaymentDateValue"

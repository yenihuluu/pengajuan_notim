...
if (isset($_POST['ticketId']) && $_POST['ticketId'] != '') {
    ...
    if ($resultData !== false && $resultData->num_rows > 0) {
        ...
        $target_date_no = $rowData->target_date_no;
    }
...
<form method="post" id="moduleDataForm" enctype="multipart/form-data">
    <input type="hidden" name="action" id="action" value="ticket-assign" />
    ...
    <div class="row-fluid" style="margin-bottom: 7px;">
        ...
        <div class="span4 lightblue">
            ...
            <textarea class="span12" readonly rows="3" tabindex="" id="assignNotes" name="assignNotes"><?php echo $assignNotes; ?></textarea>
        </div>
    </div>
    <?php
    if ($status == 2) {
        ...
        <div class="row-fluid">
            ...
            ?>
                <div class="row-fluid" style="margin-bottom: 7px;">
                    <div class="span4 lightblue">
                        <label>Start Date <span style="color: red;">*</span></label>
                        <input type="text" <?php if($startDate!=null){?> readonly <?php } ?> placeholder="DD/MM/YYYY" tabindex="4" id="startDate" value="<?php echo $startDate; ?>" name="startDate" data-date-format="dd/mm/yyyy" class="datepicker">
                    </div>
                    <div class="span4 lightblue">
                        <label>Target Date <span style="color: red;">*</span></label>
                        
                        <input type="text" placeholder="DD/MM/YYYY" tabindex="4" id="targetDate" value="<?php echo $targetDate; ?>" name="targetDate" data-date-format="dd/mm/yyyy" class="datepicker">
                    </div>
                    <div class="span4 lightblue">
                        <label>Screenshot Result<span style="color: red;">**</span></label>
                        <input type="file" placeholder="File" tabindex="" id="file_result" name="file_result" class="span12">
                        <?php if ($screenshot_result != '') { ?>
                            <a href="<?php echo $screenshot_result; ?>" target="_blank" role="button" title="view screenshot result"><img src="assets/ico/file.png" width="18px" height="18px" style="margin-bottom: 5px;" /></a>
                        <?php } ?>
                    </div>
                ...
                <div class="row-fluid" style="margin-bottom: 7px;">
                    ...
                    <div class="span4 lightblue">
                        <label>Finish Notes<span style="color: red;">**</span></label>
                        <textarea class="span12" rows="3" tabindex="" id="finish_note" name="finish_note"><?php echo $finish_note; ?></textarea>
                        <label><span style="color: red;">**Screenshot Result dan Finish Notes diisi jika sudah selesai dikerjakan</span></label>
                    </div>
                </div>
                <div class="row-fluid">
                    <div class="span12 lightblue">

...
<form method="post" id="PoDataForm">
    ...
    <div class="row-fluid" style="margin-bottom: 7px;">
		...
		<a href="" id="docContract" role="button" title="View" target="_blank"><img src="assets/ico/gnome-print.png" width="18px" height="18px" style="margin-bottom: 5px;" /></a>	
        </div>
    </div>
	<div class="row-fluid" style="margin-bottom: 7px;">
		<div class="span4 lightblue">
        ...
        <div class="span2 lightblue">
           <label>SPB Document <span style="color: red;">*</span></label>
            <?php
            createCombo("SELECT purchasing_id FROM purchasing WHERE contract_type = 2 AND contract_id IS NULL 
		...
		<a href="" id="docSPB" role="button" title="View" target="_blank"><img src="assets/ico/gnome-print.png" width="18px" height="18px" style="margin-bottom: 5px;" /></a>
        </div>
    </div>
	<div class="row-fluid" style="margin-bottom: 7px;">   
        <div class="span4 lightblue">

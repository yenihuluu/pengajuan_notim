...
$sql = "SELECT md.*, mh.mutasi_header_id, mh.kode_mutasi, mh.total as total_header, td.percentage as termin_percentage, mbm.tipe_biaya, c.currency_id, u.uom_type,
        DATE_FORMAT(md.register_date, '%d %b %Y') AS register_date
        ...
        LEFT JOIN uom u on u.idUOM = md.uom
    ...
    if ($resultData !== false && $resultData->num_rows > 0) {
        while ($rowData = $resultData->fetch_object()) {
            ...
            <tr>
                ...
                <td><?php echo number_format($rowData->termin_percentage, 2, ".", ","); ?>%</td>
...
<!--                <td>--><?php //echo $rowData->termin_percentage; ?><!--%</td>-->
                ...
                <td><?php echo $rowData->register_date; ?></td>

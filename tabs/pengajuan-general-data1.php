...
<script type="text/javascript">
    $(function () {
        ...
        <?php } else if(isset($transaksiPO) && $transaksiPO == 2 && $transaksiOKSAKT == 3){?>
                $('#AddData').show();
                //$('#slipVehicle').hide();
        ...
        $('#transaksiOKSAKT').change(function () {
            if (document.getElementById('transaksiOKSAKT').value == 2) {
                $('#AddData').show();
                // $('#slipVehicle').hide();
            ...
            }else if(document.getElementById('transaksiOKSAKT').value == 3){ //OKS OTHERS
                $('#AddData').hide();
                // $('#slipVehicle').hide();
                $('#OKSothersLabels').show();
                $('#vendorBankIdLabel').hide(); 
...
//                         setSlipVehicle($('select[id="stockpileId"]').val(), '', $('input[id="periodefrom"]').val(), $('input[id="periodeto"]').val(), $('select[id="vendorId"]').val(), $('input[id="priceOKS"]').val(), $('select[id="generalVendorId"]').val(), 0);
//                        }
...
//    }
    ...
    // function setSlipVehicle(stockpileId, checkedSlips, periodeFrom, periodeTo, vendorId, priceOKS, gvId, pg_id) { //checkedSlips awalnya Kosong
...
//          }
//      }
//      checkSlip(stockpileId, periodeFrom, periodeTo, vendorId, priceOKS, gvId)
// }

//     function checkSlip(stockpileId, periodeFrom, periodeTo, vendorId, priceOKS, gvId) {
...
//         setSlipVehicle(stockpileId, selected, periodeFrom, periodeTo, vendorId, priceOKS, gvId, pg_id);
    ...
    <div class="row-fluid" style="margin-bottom: 10px;">
        ...
        <?php } else { ?>
            <div class="span3 lightblue" id="transaksiOKS_AKTLabel">
                ...
                createCombo("SELECT '1' as id, 'No' as info UNION
                    SELECT '2' as id, 'Yes' as info UNION
                    SELECT '3' as id, 'Others' as info;", $transaksiOKSAKT, "", "transaksiOKSAKT", "id", "info",
                    "", 11, "select2combobox100");
                ?>
            </div>

...
<form method="post" id="salesDataForm">
    ...
    <div class="row-fluid">   
        <div class="span4 lightblue">
            ...
            <input type="text" class="span12" <?php echo $readonlyProperty; ?> tabindex="1" id="salesNo" name="salesNo" value="<?php echo $salesNo; ?>" maxlength="50">
        </div>
        <div class="span4 lightblue">
    ...
    <div class="row-fluid">   
        <div class="span3 lightblue">
            ...
            createCombo("SELECT '1' as id, 'Commit' as info UNION
                    SELECT '2' as id, 'Direct' as info ;", $salesType, '', "salesType", "id", "info", 

...
if(isset($_POST['salesId']) && $_POST['salesId'] != '') {
 ...
 //   echo $sql;
    ...
    if($resultData !== false && $resultData->num_rows > 0) {
        ...
        $rsb = $rowData->rsb;
        $ggl = $rowData->ggl;
        $motthervessel = $rowData->mother_vessel;
    ...
    //            alert($('#addNew').attr('href'));
        ...
        $("#salesDataForm").validate({
            ...
            messages: {
                ...
                rsb: "RSB is a required field.",
                ggl: "GGL a required field.",
...
<form method="post" id="salesDataForm">
    ...
    <div class="row-fluid">   
        <div class="span3 lightblue">
            ...
            <input type="text" class="span12" <?php echo $readonlyProperty; ?> tabindex="1" id="shipmentNo" name="shipmentNo" value="<?php echo $shipmentNo; ?>" maxlength="50">
        </div>
        <div class="span3 lightblue">
    ...
    <div class="row-fluid">   
        <div class="span3 lightblue">
            ...
            <input type="text" class="span12" <?php echo $readonlyProperty; ?> tabindex="1" id="salesNo" name="salesNo" value="<?php echo $salesNo; ?>" maxlength="100">
        </div>
        ...
        <div class="span3 lightblue">
			...
			createCombo("SELECT cust.customer_id, cust.customer_name 
                    FROM customer cust WHERE cust.customer_id = {$customerId}", $customerId, '', "customerId", "customer_id", "customer_name", 
                    "", 6, "select2combobox100", "", "", false);
			}
            ?>
        </div>
        <div class="span3 lightblue">
            ...
            <input type="text" class="span12"  tabindex="1" id="mothervessel" name="mothervessel" value="<?php echo $motthervessel; ?>">
        </div>

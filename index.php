            ...
            <div class="container">
                ...
                <div class="nav-collapse collapse">
                    <ul class="nav">
                        ...
                        <?php if ($allowNotimMenu || $allowNewNotim || $allowRevisiTimbangan) { ?>
                            <li class="dropdown">
                        ...
                        <?php if ($allowPayment || $allowCashPayment) { ?>
                            <li class="dropdown">
                                <a href="#" class="dropdown-toggle" data-toggle="dropdown">Payments <b
                                            class="caret"></b></a>
                                <ul class="dropdown-menu">
                                    <?php if ($allowPayment) { ?>
                                        <li><a href="#payment1">Payment</a></li>
                                        ...
                                        <li><a href="#settlement-views">Settlement</a></li>
                                    <?php } ?>
                                    ...
                                    <?php if ($allowCashPayment) { ?>
                                        ...
                                        <li><a href="#approved-internal-transfer">Approval Internal Transfer</a></li>
                                    <?php } ?>
                                </ul>
                            </li>
                        <?php } ?>
                        ...
                        <li class="dropdown">
                            ...
                            <ul class="dropdown-menu">
                                ...
                                <li><a href="#logbook_prod">Logbook-prod</a></li>

                                <?php if ($allowInvoice) { ?>
                                    <li><a href="#register-invoice-general">Register Invoice General</a></li>
                                    <li><a href="#invoice-notim-views">Register Invoice Notim</a></li>
                        ...
                        if ($allowContract) {
                            ?>
                            <li class="dropdown">
                                <a href="#" class="dropdown-toggle" data-toggle="dropdown">Contracts <b
                                            class="caret"></b></a>
                                <ul class="dropdown-menu">
                        ...
                        <?php if ($allowAdminReport || $allowAccountingReport || $allowFinanceReport || $allowTaxReport || $allowFeeReport || $allowPKSReport) { ?>
                            <li class="dropdown">
                                ...
                                <ul class="dropdown-menu">
                                    ...
                                    <?php } ?>
                                    <li><a href="#costing-report">Job Costing Report</a></li>
                                    <li><a href="#prediksi-report">Prediksi Report</a></li>
                        ...
                        <li class="dropdown">
                            ...
                            <ul class="dropdown-menu">
                                ...
                                <li class="dropdown-submenu">
                                    <a tabindex="-1" href="#">Master Costing</a>
                                        <ul class="dropdown-menu">
                                            <li><a href="#job-costing-views">Job Costing</a></li>
                                            <li><a href="#tipe-biaya-views">Tipe biaya</a></li>
                                        </ul>
                                </li>
                        ...
                        <li class="dropdown">
                            ...
                            <ul class="dropdown-menu">
                                ...
                                <li><a href="#pengajuan-notim-views">Pengajuan NOTIM</a></li> 
                        ...
                        <!-- <?php// if ($allowAdjustmentPayment) { ?> -->
                            <li class="dropdown">
                                <a href="#" class="dropdown-toggle" data-toggle="dropdown">Prediksi<b
                                            class="caret"></b></a>
                                <ul class="dropdown-menu">
                                    <li><a href="#accrue-prediksi-views">Form Prediksi</a></li>
                                    <!-- <li><a href="#invoice_prediksi">Form Aktual</a></li>
                                    <li><a href="#search-invoice-prediksi">Data Aktual</a></li> -->

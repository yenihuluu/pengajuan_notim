...
<ul class="nav nav-tabs" id="myTab">
    <li class="active"><a href="#approve-pengajuan-perdin-data" data-toggle="tab">Approve Pengajuan Perdin</a></li>
</ul>
...
<div class="tab-content">
    ...
    <div class="tab-pane active" id="approve-pengajuan-perdin-data">

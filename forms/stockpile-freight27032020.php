...
<div class="row-fluid">
    <div class="span4 lightblue">
        ...
        <input type="text" class="span12" tabindex="5" id="shrink_tolerance_kg" name="shrink_tolerance_kg" value="<?php echo $shrink_tolerance_kg; ?>">
    </div>
	<div class="span4 lightblue">
        <label>Shrink Tolerance(%) <span style="color: red;"></span></label>
        <input type="text" class="span12" tabindex="5" id="shrink_tolerance_persen" name="shrink_tolerance_persen" value="<?php echo $shrink_tolerance_persen; ?>">
    </div>
	<div class="span4 lightblue">
        <label>Shrink Claim <span style="color: red;"></span></label>
        <input type="text" class="span12" tabindex="5" id="shrink_claim" name="shrink_claim" value="<?php echo $shrink_claim; ?>">
    </div>
</div>

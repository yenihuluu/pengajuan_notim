            ...
            $.ajax({
                ...
                success: function(data) {
                    ...
                    if (parseInt(returnVal[4]) != 0)	//if no errors
                    {
                        ...
                        if (returnVal[1] == 'OK') {
                            $('#dataContent').load('forms/print-transaction-new.php', {transactionId: <?php echo $row->transaction_id; ?>}, iAmACallbackFunction2);
                    ...
                    success: function(data) {
                        ...
                        if (parseInt(returnVal[4]) != 0)	//if no errors
                        {
                            ...
                            if (returnVal[1] == 'OK') {
                                ...
                                $('#dataContent').load('forms/print-transaction-new.php', { transactionId: returnVal[3] }, iAmACallbackFunction2);
...
//                                $("#successMsg").show();
    ...
    function back() {
        ...
        $('#pageContent').load('views/search-transaction-new.php', {}, iAmACallbackFunction);
    }
	$(function() {

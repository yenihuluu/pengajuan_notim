...
if (isset($_POST['requestPaymentDateValue']) && $_POST['requestPaymentDateValue'] != '') {
    $requestPaymentDateValue1 = $_POST['requestPaymentDateValue'];
}
...
<script type="text/javascript">
    ...
    function loadConfig() {
        ...
        $('#' + menu[1]).load('tabs/' + menu[1] + '.php', {
            ...
            requestPaymentDateValue: $('input[id="requestPaymentDateValue1"]').val()
        });
    }
...
<div class="tab-content">
    ...
    <input type="hidden" id="requestPaymentDateValue1" value="<?php echo $requestPaymentDateValue1; ?>"/>

...
<ul class="nav nav-tabs" id="myTab">
    <li class="active"><a href="#approve-pengajuan-general-data" data-toggle="tab">Approve Pengajuan General</a></li>
</ul>
...
<div class="tab-content">
    ...
    <div class="tab-pane active" id="approve-pengajuan-general-data">

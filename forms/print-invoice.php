...
//echo $sqlDP;
        ...
        // echo "amount awal ". $tamount1;
		$tamount = $tamount1 - $downPayment;		
        // echo "dikurang DP ". $tamount;
        // echo "nilai DP ". $downPayment;
	 ...
	 ?>
                ...
                <td><?php echo number_format($row->prediksi_amount, 2, ".", ",");?></td> 
...
<input type="text" placeholder="DD/MM/YYYY" tabindex="3" id="returnInvoiceDate" name="returnInvoiceDate" value="<?php echo $invoice_date2; ?>" data-date-format="dd/mm/yyyy" class="datepicker" >
</br>

...
$sql = "SELECT  1 AS qty, a.amount AS price, 100 AS `termin`, 1 AS `exchange_rate`, a.amount AS `amount_converted`, 0 AS `ppn_converted`, 0 AS `pph_converted`, a.amount AS `tamount_converted`, a.`remarks` AS `notes`  
FROM pengajuan_internaltf a 
WHERE a.`pengajuan_interalTF_id` = {$pgId}";

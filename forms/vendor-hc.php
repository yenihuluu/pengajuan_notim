...
if(isset($_POST['vendorHandlingId']) && $_POST['vendorHandlingId'] != '') {
    ...
    $sql = "SELECT branch FROM vendor_handling WHERE vendor_handling_id = {$vendorHandlingId}";
    $resultData = $myDatabase->query($sql, MYSQLI_STORE_RESULT);
    
    if($resultData !== false && $resultData->num_rows > 0) {
        $rowData = $resultData->fetch_object();
        $branchHC = $rowData->branch;
...
<script type="text/javascript">
    $(document).ready(function(){	//executed after the page has loaded
        ...
        $('#closeEditButton').click(function (e){
            ...
            $('#editModalHC').modal('hide');
            $('#vendor-hc').load('tabs/vendor-hc.php', {}, iAmACallbackFunction2);
        });
...
<form id="editForm" method="post" enctype="multipart/form-data" action="./data_processing.php">
    ...
    <div class="span12 lightblue">
        ...
        <input type="text" class="span9" tabindex="3" id="branchHC" name="branchHC" value="<?php echo $branchHC; ?>">
    </div>

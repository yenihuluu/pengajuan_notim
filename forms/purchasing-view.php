...
if ($row1->ho == 1) {
	$sql = "SELECT CONCAT(v.`vendor_code`, ' - ', v.vendor_name) AS vendor_name,
			...
			LEFT JOIN contract c on c.contract_id = p.contract_id WHERE p.purchasing_id = {$row1->link}";
    ...
    <tbody>
      ...
      $rejectNote = $rowData->reject_note;
        ...
        <tr>
			...
			<td><div style="text-align: right;"><?php echo number_format($rowData->harga, 2, ".", ","); ?></div></td>

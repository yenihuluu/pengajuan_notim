...
<script type="text/javascript">
    ...
    function back() {
        $.blockUI({ message: '<h4>Please wait...</h4>' }); 
        $('#pageContent').load('views/po-curah.php', {}, iAmACallbackFunction);
...
<ul class="nav nav-tabs" id="myTab">
    <li class="active"><a href="#po-curah" data-toggle="tab">Contract Curah</a></li>
</ul>
...
<div class="tab-content">
    ...
    <div class="tab-pane active" id="po-curah">

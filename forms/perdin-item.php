...
<script type="text/javascript">
    ...
    function loadConfig() {
        ...
        //alert(menu[1]);
        $('#' + menu[1]).load('tabs/' + menu[1] + '.php', {item_id: $('input[id="item_id"]').val()});
    }
    
    function back() {
        $.blockUI({ message: '<h4>Please wait...</h4>' }); 
        $('#pageContent').load('views/perdin-item.php', {}, iAmACallbackFunction);
    }
    
</script>

<ul class="nav nav-tabs" id="myTab">
    <li class="active"><a href="#perdin-item-data" data-toggle="tab">Item Details</a></li>
</ul>
...
<div class="tab-content">
    ...
    <div class="tab-pane active" id="perdin-item-data">

...
<script type="text/javascript">
    ...
    function loadConfig() {
        ...
        //alert(menu[1]);
        $('#' + menu[1]).load('tabs/' + menu[1] + '.php', {pLogbookId: $('input[id="pGeneralLogbookId"]').val()});
    }
...
<ul class="nav nav-tabs" id="myTab">
    <li class="active"><a href="#pengajuan-logbook-data" data-toggle="tab">Pengajuan Logbook Form</a></li>
	<?php
    if($boolShow) {
    ?>
...
<div class="tab-content">
    <input type="hidden" id="pGeneralLogbookId" value="<?php echo $pLogbookId; ?>" />
    <div class="alert">
    ...
    <div class="tab-pane active" id="pengajuan-logbook-data">

...
<script type="text/javascript">
    ...
    function back() {
        $.blockUI({ message: '<h4>Please wait...</h4>' });
        $('#pageContent').load('views/payment-notim-salesOA.php', {}, iAmACallbackFunction); //jika file php didalam folder FORMS kosong balik ke views
    }

</script>

<ul class="nav nav-tabs" id="myTab">
    <li class="active"><a href="#payment-notim-salesOA" data-toggle="tab">payment</a> <!-- call shipment-cost-tabs.php dlm folder TABS -->
    </li>
</ul>
...
<div class="tab-content">
    ...
    <div class="tab-pane active" id="payment-notim-salesOA">

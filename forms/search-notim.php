...
//                    }                  
           ...
           $.ajax({
               ...
               success: function(data){
                   ...
                   if(parseInt(returnVal[0])!=0)	//if no errors
                   {
                       ...
                       setSpBlock(1, $('input[id="stockpileId"]').val(), $('input[id="block1"]').val(), returnVal[2], returnVal[1] );
   ...
   function setSpBlock(type, stockpileId, block, ggl, rsb ) {
        $.ajax({
            url: 'get_data.php',
            method: 'POST',
        ...
        <div class="row-fluid">  
            ...
            <div class="span4 lightblue">
                ...
                createCombo("SELECT sp_block_id, CONCAT(CASE WHEN ggl = 1 AND rsb = 0 THEN 'GGL' 
                                ...
                                FROM mst_sp_block ORDER BY block_name ASC", $block, "", "block", "sp_block_id", "block_name", 

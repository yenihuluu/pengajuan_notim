...
<script type="text/javascript">
    $(document).ready(function(){
        $('#vendorId0').change(function() {
            if(document.getElementById('vendorId0').value == 'INSERT') {
                $('#vendorDetail1').show();
                $('#vendorDetail2').show();
                $('#vendorDetail3').show();
            } else {
...
<input type="hidden" id="action" name="action" value="transaction_vendor_data">

<div class="row-fluid">   
    <div class="span12 lightblue">
        <label>Vendor <span style="color: red;">*</span></label>
        <?php
        createCombo("SELECT v.vendor_id, v.vendor_name
                FROM vendor v
                ORDER BY v.vendor_name ASC", "", "", "vendorId0", "vendor_id", "vendor_name", 
                "", 1, "span6", 1, "", true);
        ?>
    </div>
</div>
...
<div class="row-fluid" id="vendorDetail1" style="display: none;">
    <div class="span4 lightblue">
        ...
        <input type="text" class="span12" tabindex="2" id="vendorCode" name="vendorCode">
    </div>
    <div class="span8 lightblue">
        <label>Vendor Name <span style="color: red;">*</span></label>
        <input type="text" class="span12" tabindex="3" id="vendorName" name="vendorName">
    </div>
</div>
...
<div class="row-fluid" id="vendorDetail3" style="display: none;">
    <div class="span6 lightblue">
    ...
    <div class="span6 lightblue">
        ...
        <textarea class="span12" rows="3" tabindex="7" id="vendorAddress" name="vendorAddress"></textarea>
    </div>
</div>

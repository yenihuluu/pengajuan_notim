...
<input type="hidden" id="action" name="action" value="transaction_customer_data">


<div class="row-fluid">
    <div class="span6 lightblue">
        <label>Customer Name <span style="color: red;">*</span></label>
        <input type="text" class="span12" tabindex="1" id="customerName" name="customerName">
    </div>
    <div class="span6 lightblue">
...
<div class="row-fluid">
    <div class="span12 lightblue">
        ...
        <textarea class="span11" rows="3" tabindex="4" id="customerAddress" name="customerAddress"></textarea>
    </div>
</div>

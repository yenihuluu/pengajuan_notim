...
<script type="text/javascript">
    ...
    function loadConfig() {
        ...
        //alert(menu[1]);
        $('#' + menu[1]).load('tabs/' + menu[1] + '.php', {paymentId: $('input[id="paymentId"]').val()});
    }
    
    function back() {
        $.blockUI({ message: '<h4>Please wait...</h4>' }); 
        $('#pageContent').load('views/updatePayment.php', {}, iAmACallbackFunction);
    }
    
</script>

<ul class="nav nav-tabs" id="myTab">
    <li class="active"><a href="#updatePayment-data" data-toggle="tab">Update Payment</a></li>
...
<div class="tab-content">
    ...
    <div class="tab-pane active" id="updatePayment-data">

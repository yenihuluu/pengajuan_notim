...
<input type="text" placeholder="DD/MM/YYYY" tabindex="3" id="rejectContractDate" name="rejectContractDate" value="<?php echo $row->contractDate; ?>" data-date-format="dd/mm/yyyy" class="datepicker" >
</br>

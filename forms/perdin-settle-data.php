...
if(isset($_POST['settleId']) && $_POST['settleId'] != '') {
    ...
    $sql = "SELECT a.*, DATE_FORMAT(a.tanggal,'%d/%m/%Y') AS tanggal2,e.`approval_status`, f.`category`, e.origin
...
//}		
	...
	<?php
        ...
        ?>
		//alert('bb');
		setUser(0,<?php echo $stockpile_id; ?>,0);
		<?php
		}else{
        ?>
		setUser(1,<?php echo $stockpile_id; ?>,<?php echo $userTo; ?>);
...
<div class="row-fluid">
	...
	<div class="span3 lightblue">
			...
			createCombo("SELECT '4' as id, 'Loading' as info UNION
                    SELECT '5' as id, 'Umum' as info;", $settlementType, $readonlyProperty, "settlementType", "id", "info", 
                "", 11, "select2combobox100");?>
			
        </div> 
	<div class="span3 lightblue">
        <label>Account</label>
		<?php createCombo("", $accountId, $readonlyProperty, "accountId", "id", "info", "", "", "select2combobox100", 4);	?>
    </div>
	<div class="span3 lightblue">
        <label>Shipment Code </label>
            <?php
...
<div class="span4 lightblue">
            ...
            <?php
            createCombo("SELECT item_id, item FROM perdin_item ORDER BY item_id DESC", $item_id, $readonlyProperty, "item_id", "item_id", "item", "", "", "select2combobox100", 1);
            ?>
        </div> 	
    <div class="span3 lightblue">

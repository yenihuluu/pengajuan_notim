...
<script type="text/javascript">
    ...
    function loadConfig() {
        ...
        //alert(menu[1]);
        $('#' + menu[1]).load('tabs/' + menu[1] + '.php', {purchaseId: $('input[id="purchaseId"]').val()});
    }
...
<ul class="nav nav-tabs" id="myTab">
    <li class="active"><a href="#purchasing-data" data-toggle="tab">Purchasing Details</a></li>
</ul>
...
<div class="tab-content">
    ...
    <div class="tab-pane active" id="purchasing-data">

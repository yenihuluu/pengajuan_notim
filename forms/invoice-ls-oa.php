...
<script type="text/javascript">
    ...
    function back() {
        $.blockUI({ message: '<h4>Please wait...</h4>' });
        $('#pageContent').load('views/invoice-ls-oa.php', {}, iAmACallbackFunction); //jika file php didalam folder FORMS kosong balik ke views
    }

</script>

<ul class="nav nav-tabs" id="myTab">
    <li class="active"><a href="#invoice-ls-oa" data-toggle="tab">Approve Invoice Notim</a> <!-- call shipment-cost-tabs.php dlm folder TABS -->
    </li>
</ul>
...
<div class="tab-content">
    ...
    <div class="tab-pane active" id="invoice-ls-oa">

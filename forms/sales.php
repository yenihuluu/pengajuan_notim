...
<script type="text/javascript">
    ...
    function back() {
        $.blockUI({ message: '<h4>Please wait...</h4>' }); 
        $('#pageContent').load('views/sales.php', {}, iAmACallbackFunction);
...
<ul class="nav nav-tabs" id="myTab">
    <li class="active"><a href="#sales-data" data-toggle="tab">Sales Agreement Details</a></li>
</ul>
...
<div class="tab-content">
    ...
    <div class="tab-pane active" id="sales-data">

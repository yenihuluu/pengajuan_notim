...
$sql = "SELECT t.*, DATE_FORMAT(t.transaction_date, '%d/%m/%Y') AS transaction_date2, 
		...
		LEFT JOIN transaction_upload tu
			ON tu.slip_id = t.slip_upload
...
if($result->num_rows == 1) {
    ...
    $pph = $row->pph;
	$slipNo = $row->slip_no;
	$slipUpload = $row->slip_upload;
	$slipUpload2 = $row->no_slip;
	$poNo = $row->po_no;
...
//        });
        ...
        if($transactionType == 1) {
            ...
            ?>
            //setContract(1, $('input[id="idSuratTugas"]').val(), $('input[id="stockpileId"]').val(), <?php echo $vendorId; ?>, <?php echo $stockpileContractId; ?>);
...
<form method="post" id="transactionDataForm">
    ...
    <div id="inTransaction">
        ...
        <div class="row-fluid">  
            ...
            <div class="span4 lightblue">
                <input type="text" class="span12" tabindex="29" id="sendWeight" name="sendWeight" value="<?php echo number_format($sendWeight, 2, '.', ','); ?>">
            </div>
        </div>
        <div class="row-fluid">  
            <div class="span2 lightblue">
            ...
            <div class="span4 lightblue">
                <input type="text" class="span12" readonly tabindex="30" id="brutoWeight" name="brutoWeight" value="<?php echo number_format($brutoWeight, 2, '.', ','); ?>">
            </div>
        </div>
        <div class="row-fluid">  
            <div class="span2 lightblue">
            ...
            <div class="span4 lightblue">
                <input type="text" class="span12" readonly tabindex="31" id="tarraWeight" name="tarraWeight" value="<?php echo number_format($tarraWeight, 2, '.', ','); ?>">
            </div>
        </div>
        <hr>
        <div class="row-fluid">  

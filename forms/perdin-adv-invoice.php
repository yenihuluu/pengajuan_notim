...
$adv_detail_id = $_POST['adv_detail_id'];
...
//$settlementType = '';
//$shipment_id = '';
if(isset($_POST['adv_detail_id']) && $_POST['adv_detail_id'] != '') {
    ...
    $sql = "SELECT sa_id, keterangan AS notes FROM perdin_adv_detail WHERE adv_detail_id = {$adv_detail_id}";
           // echo $sql;
    ...
    if($resultData !== false && $resultData->num_rows > 0) {
	   ...
	   if($rowData->approval_status == 1 && $rowData->category == 0){
...
function resetsetPPh(text) {
	...
	<?php
       // if($userTo != "") {
        ?>
		//alert('bb');
		//setUser(1,<?php //echo $stockpile_id; ?>,<?php //echo $userTo; ?>);
		<?php
		//}	
        ?>
...
//}		
	...
	<?php
       // if($stockpile_id != "") {
        ?>
		//alert('bb');
		//setUser(0,<?php //echo $stockpile_id; ?>,<?php //echo $userTo; ?>);
		<?php
		//}
        ?>
...
/*function setUser(type,stockpile_id, userTo) {
       ...
       // if($id_user != "" && $type == 0) {
        ?>
		//alert('bb');
		//setAdvancePerdin(<?php //echo $id_user; ?>, <?php// echo $stockpile_id; ?>);
		<?php
		//}
        ?>	


/*function setAdvancePerdin(id_user, stockpile_id) {
		//alert('aa');
        $.ajax({
            url: 'get_data.php',
            method: 'POST',
...
<input type="hidden" id="action" name="action" value="perdin_adv_detail">
<input type="hidden" class="span12"  tabindex="" id="sa_id" name="sa_id" value="<?php echo $sa_id; ?>"  >
<input type="hidden" class="span12"  tabindex="" id="adv_detail_id" name="adv_detail_id" value="<?php echo $adv_detail_id; ?>"  >
...
<input type="hidden" class="span12"  tabindex="" id="approveInvoice" name="approveInvoice" value="1"  >-->
...
<!--	<div class="span3 lightblue">
	...
	<div class="span3 lightblue">
        <label>Shipment Code </label>
            <?php
            //createCombo("SELECT shipment_id, shipment_no FROM shipment ORDER BY shipment_id DESC", $shipment_id, $readonlyProperty, "shipment_id", "shipment_id", "shipment_no", "", "", "select2combobox100", 1);
            ?>
        </div>-->
...
<div class="row-fluid">
	...
	<!--<div class="span3 lightblue">
        <label>To<span style="color: red;">*</span></label>
            <?php //createCombo("", $userTo, $readonlyProperty, "userTo", "id_user", "nama", "", "", "select2combobox100", 4);	?>
    </div>
<div class="span4 lightblue">
            <label>Items <span style="color: red;">*</span></label>
			<input type="hidden" class="span12" tabindex="" id="item_id" name="item_id" value="<?php //echo $item_id; ?>">
			<input type="text" readOnly class="span12" tabindex="" id="item" name="item" value="<?php //echo $item; ?>">
            
        </div> 	
    <div class="span3 lightblue">
        <label>Date<span style="color: red;">*</span></label>
      	<input type="text" <?php //echo $readonlyProperty ?> placeholder="DD/MM/YYYY" tabindex="" id="tanggal" name="tanggal" value="<?php //echo $tanggal; ?>" data-date-format="dd/mm/yyyy" class="datepicker" >
        </div>-->
    <!--<div class="span2 lightblue">
        <label>Termin (%)</label>
        <input type="text" class="span12"  tabindex="" id="termin" name="termin"  maxlength="3" min="0" max="100">
...
<div class="row-fluid">
  <!-- <div class="span3 lightblue">
        <label>UOM <span style="color: red;">*</span></label>
            ...
            //createCombo("SELECT *
                    //FROM uom 
                    //ORDER BY uom_type ASC", $uom, $readonlyProperty, "uom", "idUOM", "uom_type", 
                    //"", "", "select2combobox100");
            ?>
    </div>
	...
	<div class="span3 lightblue">
        <label>Qty</label>
        <input type="text" <?php //echo $readonlyProperty ?> class="span12"  tabindex="" id="qty" name="qty" value="<?php //echo $qty ?>" >
    </div>		
    <div class="span3 lightblue">
        <label>Unit Price</label>
        <input type="text" <?php //echo $readonlyProperty ?> class="span12"  tabindex="" id="price" name="price"  value="<?php //echo $price ?>" >
    </div>-->
    <!--<div class="span2 lightblue">
        <label>Termin (%)</label>
        <input type="text" class="span12"  tabindex="" id="termin" name="termin"  maxlength="3" min="0" max="100">

...
<input type="text" placeholder="DD/MM/YYYY" tabindex="3" id="returnPaymentDate" name="returnPaymentDate" value="<?php echo $row->payment_date3; ?>" data-date-format="dd/mm/yyyy" class="datepicker" >
</br>

...
if(isset($_POST['invoiceDetailId']) && $_POST['invoiceDetailId'] != '') {
    ...
    if($resultData !== false && $resultData->num_rows > 0) {
        ...
        $tipeBiayaId = $rowData->biaya_id;
		$generalVendorId = $rowData->general_vendor_id;
        $oldPrediksi = $rowData->prediction_detail_id;
 ...
 $(document).ready(function(){
    ...
    $('#shipmentId1').change(function() {
		...
		if(document.getElementById('shipmentId1').value != '') {
            getPrediksiId(0, $('select[id="shipmentId1"]').val(), $('input[id="tipeBiayaId"]').val(), $('input[id="generalVendorId"]').val(), 0);
		}
    });
...
<input type="hidden" id="tipeBiayaId" name="tipeBiayaId" value="<?php echo $tipeBiayaId; ?>">
<input type="hidden" id="generalVendorId" name="generalVendorId" value="<?php echo $generalVendorId; ?>">
<input type="hidden" id="oldPrediksi" name="oldPrediksi" value="<?php echo $oldPrediksi; ?>">
...
<div class="row-fluid">
    <div class="span12 lightblue" id="divCodePrediksi" style="display: none;">

...
WHERE mh.mutasi_header_id = {$mutasiId} and c.mutasi_type = 1 and sc.status_mutasi = 0
UNION ALL
...
left join stock_transit st on st.stockpile_contract_id = sc.stockpile_contract_id
left join mutasi_contract mc on mc.stockpile_contract_id = sc.stockpile_contract_id
WHERE mh.mutasi_header_id = {$mutasiId} and c.mutasi_type = 0 and c.langsir = 1 and sc.status_mutasi = 0", $stockpileContractId, '', "stockpileContractId", "stockpile_contract_id", "contract_no",

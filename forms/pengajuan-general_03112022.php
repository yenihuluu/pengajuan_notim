...
if (isset($_POST['transaksiOKSAKT']) && $_POST['transaksiOKSAKT'] != '') {
    $oks_akt = $_POST['transaksiOKSAKT'];
}
if (isset($_POST['paymentType']) && $_POST['paymentType'] != '') {
    $paymentType1 = $_POST['paymentType'];
}
if (isset($_POST['requestPaymentDateValue']) && $_POST['requestPaymentDateValue'] != '') {
    $reqPaymentDate = $_POST['requestPaymentDateValue'];
}
if (isset($_POST['requestPaymentDateValue2']) && $_POST['requestPaymentDateValue2'] != '') {
    $reqPaymentDate2 = $_POST['requestPaymentDateValue2'];
}

// echo " nilai OKS " . $oks_akt . " || " . $paymentType;
...
<script type="text/javascript">
    ...
    function loadConfig() {
        ...
        $('#' + menu[1]).load('tabs/' + menu[1] + '.php', {
            ...
            transaksiOKSAKT: $('input[id="oks_akt"]').val(),
            paymentType: $('input[id="paymentType1"]').val(),
            requestPaymentDateValue: $('input[id="reqPaymentDate"]').val(),
            requestPaymentDateValue2: $('input[id="reqPaymentDate2"]').val()
...
<div class="tab-content">
    ...
    <input type="hidden" id="oks_akt" value="<?php echo $oks_akt; ?>"/>
    <input type="hidden" id="paymentType1" value="<?php echo $paymentType1; ?>"/>
    <input type="hidden" id="reqPaymentDate" value="<?php echo $reqPaymentDate; ?>"/>
    <input type="hidden" id="reqPaymentDate2" value="<?php echo $reqPaymentDate2; ?>"/>

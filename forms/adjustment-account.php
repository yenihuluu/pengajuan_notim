...
WHERE  gl.amount > 0 AND general_ledger_module = 'CONTRACT ADJUSTMENT' AND gl.description = {$adjId} AND gl.contract_id = {$contractId}";
...
<div class="row-fluid">   
    ...
    <tbody>
        ...
        if($resultData !== false && $resultData->num_rows > 0) {
			...
			if($rowData->general_ledger_module == 'CONTRACT ADJUSTMENT'){

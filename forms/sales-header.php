...
<script type="text/javascript">
    ...
    function loadConfig() {
        ...
        //alert(menu[1]);
        $('#' + menu[1]).load('tabs/' + menu[1] + '.php', {salesHeaderId: $('input[id="salesHeaderId"]').val()});
    }
    
    function back() {
        $.blockUI({ message: '<h4>Please wait...</h4>' }); 
        $('#pageContent').load('views/sales-header.php', {}, iAmACallbackFunction);
    }
    
</script>

<ul class="nav nav-tabs" id="myTab">
    <li class="active"><a href="#sales-header-data" data-toggle="tab">Sales</a></li>
</ul>
...
<div class="tab-content">
    ...
    <div class="tab-pane active" id="sales-header-data">

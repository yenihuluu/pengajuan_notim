...
$('#contentTable a').click(function(e){
    ...
    //            alert($('#addNew').attr('href'));
                $('#addDetailModalForm').load('forms/detail-endstock.php', {period: menu[1],stockpileCode: menu[2]}, iAmACallbackFunction2);	//and hide the rotating gif
...
<form method="post" action="reports/management-report-xls.php">
...
?>		
        <tr>
            <td><a href="#" id="detail|<?php echo $period; ?>|<?php echo $stockpile_code; ?>" role="button"><?php echo $stockpile;?></a></td>

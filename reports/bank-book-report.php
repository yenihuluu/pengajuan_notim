...
WHEN p.payment_type = 2 AND p.ppn_journal > 0 AND p.freight_id IS NOT NULL AND (SELECT account_id FROM `bank` WHERE bank_id = {$bankId}) != p.account_id THEN p.original_amount_converted / p.exchange_rate
...
<form method="post" id="downloadxls" action="reports/bank-book-report-xls.php">

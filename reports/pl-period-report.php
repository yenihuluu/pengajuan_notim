...
<form method="post" id="downloadxls" action="reports/pl-period-report-xls.php">
...
<table class="table table-bordered table-striped" style="font-size: 8pt;">
    ...
    <tbody>
        ...
        <tr>
            ...
            <td style="text-align: left;"><?php echo $row->account_pl_no; ?></td>

            <td style="text-align: left;"><?php echo $row->account_pl_name; ?></td>

...
$sql = "SELECT  SUM(COALESCE(a.sendweight1,0)) AS sendweight,
        ...
        a.* FROM 
            ...
            -- CASE WHEN (lab.laborRules = '1') THEN COALESCE(tr.unloading_price,0)
            ...
            -- CASE WHEN (tr.slip_retur IS NOT NULL ) AND (COALESCE(tr.send_weight,0)*-1 <= COALESCE(tr.netto_weight,0)*-1)
...
$objPHPExcel->getActiveSheet()->setCellValue("J{$rowActive}", "Total Amount Susut");

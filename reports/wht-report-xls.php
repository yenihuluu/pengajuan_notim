...
$objPHPExcel->getActiveSheet()->setCellValue("U{$rowActive}", "Jenis PPh");
$objPHPExcel->getActiveSheet()->setCellValue("V{$rowActive}", "Tarif");
$objPHPExcel->getActiveSheet()->setCellValue("W{$rowActive}", "Nama");
$objPHPExcel->getActiveSheet()->setCellValue("X{$rowActive}", "NPWP");
$objPHPExcel->getActiveSheet()->setCellValue("Y{$rowActive}", "NIK");
$objPHPExcel->getActiveSheet()->setCellValue("Z{$rowActive}", "Alamat");
$objPHPExcel->getActiveSheet()->setCellValue("AA{$rowActive}", "Dokumen Faktur");
$objPHPExcel->getActiveSheet()->setCellValue("AB{$rowActive}", "Dokumen PKHOA");
...
while($row = mysqli_fetch_array($result)){
	...
	$objPHPExcel->getActiveSheet()->setCellValue("P{$rowActive}", $row['total'] - $row['dp']);
	...
	$objPHPExcel->getActiveSheet()->setCellValue("U{$rowActive}", $row['jenis_pph']);
	$objPHPExcel->getActiveSheet()->setCellValue("V{$rowActive}", $row['tarif']);
	$objPHPExcel->getActiveSheet()->setCellValue("W{$rowActive}", $row['nama']);
	//$objPHPExcel->getActiveSheet()->setCellValue("W{$rowActive}", $row['npwp']);
	$objPHPExcel->getActiveSheet()->setCellValueExplicit("X{$rowActive}", $row['npwp'], PHPExcel_Cell_DataType::TYPE_STRING);
	$objPHPExcel->getActiveSheet()->setCellValueExplicit("Y{$rowActive}", $row['nik'], PHPExcel_Cell_DataType::TYPE_STRING);
	$objPHPExcel->getActiveSheet()->setCellValue("Z{$rowActive}", $row['alamat']);
	//$objPHPExcel->getActiveSheet()->setCellValue("Y{$rowActive}", $row['doc_faktur']);
	$objPHPExcel->getActiveSheet()->setCellValueExplicit("AA{$rowActive}", $row['doc_faktur'], PHPExcel_Cell_DataType::TYPE_STRING);
	//$objPHPExcel->getActiveSheet()->setCellValue("Z{$rowActive}", $row['doc_pkhoa']);
	$objPHPExcel->getActiveSheet()->setCellValueExplicit("AB{$rowActive}", $row['doc_pkhoa'], PHPExcel_Cell_DataType::TYPE_STRING);
...
// Set column width
for ($temp = ord("A"); $temp <= ord("AB"); $temp++) {

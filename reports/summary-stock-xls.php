...
$objPHPExcel->getActiveSheet()->setCellValue("B{$rowActive}", "BATU LICIN");
$objPHPExcel->getActiveSheet()->mergeCells("F{$rowActive}:I{$rowActive}");
$objPHPExcel->getActiveSheet()->setCellValue("F{$rowActive}", "BENGKULU");
$objPHPExcel->getActiveSheet()->mergeCells("J{$rowActive}:M{$rowActive}");
$objPHPExcel->getActiveSheet()->setCellValue("J{$rowActive}", "PANGKALAN BUN");
...
$objPHPExcel->getActiveSheet()->setCellValue("R{$rowActive}", "DUMAI");
$objPHPExcel->getActiveSheet()->mergeCells("V{$rowActive}:Y{$rowActive}");
$objPHPExcel->getActiveSheet()->setCellValue("V{$rowActive}", "JAKARTA");
$objPHPExcel->getActiveSheet()->mergeCells("Z{$rowActive}:AC{$rowActive}");
$objPHPExcel->getActiveSheet()->setCellValue("Z{$rowActive}", "JAMBI");
$objPHPExcel->getActiveSheet()->mergeCells("AD{$rowActive}:AG{$rowActive}");
$objPHPExcel->getActiveSheet()->setCellValue("AD{$rowActive}", "MAREDAN");
$objPHPExcel->getActiveSheet()->mergeCells("AH{$rowActive}:AK{$rowActive}");
$objPHPExcel->getActiveSheet()->setCellValue("AH{$rowActive}", "PADANG");
$objPHPExcel->getActiveSheet()->mergeCells("AL{$rowActive}:AO{$rowActive}");
$objPHPExcel->getActiveSheet()->setCellValue("AL{$rowActive}", "PALEMBANG");
$objPHPExcel->getActiveSheet()->mergeCells("AP{$rowActive}:AS{$rowActive}");
$objPHPExcel->getActiveSheet()->setCellValue("AP{$rowActive}", "PEKANBARU");
$objPHPExcel->getActiveSheet()->mergeCells("AT{$rowActive}:AW{$rowActive}");
$objPHPExcel->getActiveSheet()->setCellValue("AT{$rowActive}", "PONTIANAK");
$objPHPExcel->getActiveSheet()->mergeCells("AX{$rowActive}:BA{$rowActive}");
$objPHPExcel->getActiveSheet()->setCellValue("AX{$rowActive}", "RENGAT");
$objPHPExcel->getActiveSheet()->mergeCells("BB{$rowActive}:BE{$rowActive}");
$objPHPExcel->getActiveSheet()->setCellValue("BB{$rowActive}", "SAMPIT");
$objPHPExcel->getActiveSheet()->mergeCells("BF{$rowActive}:BI{$rowActive}");
$objPHPExcel->getActiveSheet()->setCellValue("BF{$rowActive}", "SAMARINDA");
$objPHPExcel->getActiveSheet()->mergeCells("BJ{$rowActive}:BM{$rowActive}");
$objPHPExcel->getActiveSheet()->setCellValue("BJ{$rowActive}", "TAYAN");
...
if($resultHead->num_rows > 0){
    ...
    while($rowHead = $resultHead->fetch_object()) {
        ...
        $objPHPExcel->getActiveSheet()->setCellValue("B{$rowActive}", $rowHead->qtyBat); 
        $objPHPExcel->getActiveSheet()->setCellValue("C{$rowActive}", $rowHead->CountDayBat); 
        $objPHPExcel->getActiveSheet()->setCellValue("D{$rowActive}", $rowHead->countVehicleBATNotim); 
        $objPHPExcel->getActiveSheet()->setCellValue("E{$rowActive}", $rowHead->countVehicleBATTim);

        $objPHPExcel->getActiveSheet()->setCellValue("F{$rowActive}", $rowHead->qtyBen); 
        $objPHPExcel->getActiveSheet()->setCellValue("G{$rowActive}", $rowHead->CountDayBen); 
        $objPHPExcel->getActiveSheet()->setCellValue("H{$rowActive}", $rowHead->countVehicleBENotim); 
        $objPHPExcel->getActiveSheet()->setCellValue("I{$rowActive}", $rowHead->countVehicleBENTim);
        
        $objPHPExcel->getActiveSheet()->setCellValue("J{$rowActive}", $rowHead->qtyBUN); 
        $objPHPExcel->getActiveSheet()->setCellValue("K{$rowActive}", $rowHead->CountDayBUN); 
        ...
        $objPHPExcel->getActiveSheet()->setCellValue("O{$rowActive}", $rowHead->CountDayBUT); 
        $objPHPExcel->getActiveSheet()->setCellValue("P{$rowActive}", $rowHead->countVehicleBUTNotim); 
        $objPHPExcel->getActiveSheet()->setCellValue("Q{$rowActive}", $rowHead->countVehicleBUTTim);

        $objPHPExcel->getActiveSheet()->setCellValue("R{$rowActive}", $rowHead->qtyDUM); 
        $objPHPExcel->getActiveSheet()->setCellValue("S{$rowActive}", $rowHead->CountDayDUM); 
        $objPHPExcel->getActiveSheet()->setCellValue("T{$rowActive}", $rowHead->countVehicleDUMNotim); 
        $objPHPExcel->getActiveSheet()->setCellValue("U{$rowActive}", $rowHead->countVehicleDUMTim);

        $objPHPExcel->getActiveSheet()->setCellValue("V{$rowActive}", $rowHead->qtyHO); 
        $objPHPExcel->getActiveSheet()->setCellValue("W{$rowActive}", $rowHead->CountDayHO); 
        $objPHPExcel->getActiveSheet()->setCellValue("X{$rowActive}", $rowHead->countVehicleHONotim); 
        $objPHPExcel->getActiveSheet()->setCellValue("Y{$rowActive}", $rowHead->countVehicleHOTim);

        $objPHPExcel->getActiveSheet()->setCellValue("Z{$rowActive}", $rowHead->qtyJAM); 
        $objPHPExcel->getActiveSheet()->setCellValue("AA{$rowActive}", $rowHead->CountDayJAM); 
        $objPHPExcel->getActiveSheet()->setCellValue("AB{$rowActive}", $rowHead->countVehicleJAMNotim); 
        $objPHPExcel->getActiveSheet()->setCellValue("AC{$rowActive}", $rowHead->countVehicleJAMTim);

        $objPHPExcel->getActiveSheet()->setCellValue("AD{$rowActive}", $rowHead->qtyMAR); 
        $objPHPExcel->getActiveSheet()->setCellValue("AE{$rowActive}", $rowHead->CountDayMAR); 
        $objPHPExcel->getActiveSheet()->setCellValue("AF{$rowActive}", $rowHead->countVehicleMARNotim); 
        $objPHPExcel->getActiveSheet()->setCellValue("AG{$rowActive}", $rowHead->countVehicleMARTim);

        $objPHPExcel->getActiveSheet()->setCellValue("AH{$rowActive}", $rowHead->qtyPAD); 
        $objPHPExcel->getActiveSheet()->setCellValue("AI{$rowActive}", $rowHead->CountDayPAD); 
        $objPHPExcel->getActiveSheet()->setCellValue("AJ{$rowActive}", $rowHead->countVehiclePADNotim); 
        $objPHPExcel->getActiveSheet()->setCellValue("AK{$rowActive}", $rowHead->countVehiclePADTim);

        $objPHPExcel->getActiveSheet()->setCellValue("AL{$rowActive}", $rowHead->qtyPAL); 
        $objPHPExcel->getActiveSheet()->setCellValue("AM{$rowActive}", $rowHead->CountDayPAL); 
        $objPHPExcel->getActiveSheet()->setCellValue("AN{$rowActive}", $rowHead->countVehiclePALNotim); 
        $objPHPExcel->getActiveSheet()->setCellValue("AO{$rowActive}", $rowHead->countVehiclePALTim);

        $objPHPExcel->getActiveSheet()->setCellValue("AP{$rowActive}", $rowHead->qtyPEK); 
        $objPHPExcel->getActiveSheet()->setCellValue("AQ{$rowActive}", $rowHead->CountDayPEK); 
        $objPHPExcel->getActiveSheet()->setCellValue("AR{$rowActive}", $rowHead->countVehiclePEKNotim); 
        $objPHPExcel->getActiveSheet()->setCellValue("AS{$rowActive}", $rowHead->countVehiclePEKTim);

        $objPHPExcel->getActiveSheet()->setCellValue("AT{$rowActive}", $rowHead->qtyPON); 
        $objPHPExcel->getActiveSheet()->setCellValue("AU{$rowActive}", $rowHead->CountDayPON); 
        $objPHPExcel->getActiveSheet()->setCellValue("AV{$rowActive}", $rowHead->countVehiclePONNotim); 
        $objPHPExcel->getActiveSheet()->setCellValue("AW{$rowActive}", $rowHead->countVehiclePONTim);

        $objPHPExcel->getActiveSheet()->setCellValue("AX{$rowActive}", $rowHead->qtyREN); 
        $objPHPExcel->getActiveSheet()->setCellValue("AY{$rowActive}", $rowHead->CountDayREN); 
        $objPHPExcel->getActiveSheet()->setCellValue("AZ{$rowActive}", $rowHead->countVehicleRENNotim); 
        $objPHPExcel->getActiveSheet()->setCellValue("BA{$rowActive}", $rowHead->countVehicleRENTim);

        $objPHPExcel->getActiveSheet()->setCellValue("BB{$rowActive}", $rowHead->qtySAM); 
        $objPHPExcel->getActiveSheet()->setCellValue("BC{$rowActive}", $rowHead->CountDaySAM); 
        $objPHPExcel->getActiveSheet()->setCellValue("BD{$rowActive}", $rowHead->countVehicleSAMNotim); 
        $objPHPExcel->getActiveSheet()->setCellValue("BE{$rowActive}", $rowHead->countVehicleSAMTim);

        $objPHPExcel->getActiveSheet()->setCellValue("BF{$rowActive}", $rowHead->qtySMR); 
        $objPHPExcel->getActiveSheet()->setCellValue("BG{$rowActive}", $rowHead->CountDaySMR); 
        $objPHPExcel->getActiveSheet()->setCellValue("BH{$rowActive}", $rowHead->countVehicleSMRNotim); 
        $objPHPExcel->getActiveSheet()->setCellValue("BI{$rowActive}", $rowHead->countVehicleSMRTim);

        $objPHPExcel->getActiveSheet()->setCellValue("BJ{$rowActive}", $rowHead->qtyTYN); 
        $objPHPExcel->getActiveSheet()->setCellValue("BK{$rowActive}", $rowHead->CountDayTYN); 
        $objPHPExcel->getActiveSheet()->setCellValue("BL{$rowActive}", $rowHead->countVehicleTYNNotim); 
        $objPHPExcel->getActiveSheet()->setCellValue("BM{$rowActive}", $rowHead->countVehicleTYNTim);

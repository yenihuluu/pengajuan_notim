...
if(isset($_POST['paymentFrom']) && $_POST['paymentFrom'] != '' && isset($_POST['paymentTo']) && $_POST['paymentTo'] != '') {
    ...
    //$whereProperty2 .= " AND p.payment_date BETWEEN '2020-01-01' AND STR_TO_DATE('{$paymentTo}', '%d/%m/%Y') ";
	$whereProperty3 .= " AND payment_date BETWEEN '2020-01-01' AND STR_TO_DATE('{$paymentTo}', '%d/%m/%Y') ";
...
if(isset($_POST['periodFrom']) && $_POST['periodFrom'] != '' && isset($_POST['periodTo']) && $_POST['periodTo'] != '') {
	...
	//$whereProperty4 .= " AND date BETWEEN '2020-01-01' AND STR_TO_DATE('{$periodTo}', '%d/%m/%Y') ";
...
(ROUND((t.`handling_quantity` * t.`handling_price`),10) - ROUND(((t.`handling_quantity` * t.`handling_price`) * (vh.pph / 100)),10)) AS total,
	  ...
	  var wto;
        $('#downloadxls').submit(function (e) {
            ...
            wto = setTimeout(function () {
				...
				vendorHandlingId: $('input[id="vendorHandlingId"]').val(),
         ...
         <form class="form-horizontal" id="downloadxls" method="post" action="reports/hdhandling-report-xls.php" >

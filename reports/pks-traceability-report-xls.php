...
$objPHPExcel->getActiveSheet()->setCellValue("I{$rowActive}", "INVENTORY (KG)");
$objPHPExcel->getActiveSheet()->mergeCells("J{$rowActive}:J{$rowMerge}");
$objPHPExcel->getActiveSheet()->setCellValue("J{$rowActive}", "PKS SOURCE DETAIL");
...
while($row = $result->fetch_object()) {
   ...
   /* $objPHPExcel->getActiveSheet()->setCellValue("F{$rowActive}", $row->freight_code);
	...
	$objPHPExcel->getActiveSheet()->setCellValue("J{$rowActive}", $row->vendor_curah_name);

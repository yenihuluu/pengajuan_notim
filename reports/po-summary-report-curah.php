...
?>
<form method="post" action="reports/po-summary-report-curah-xls.php">
...
SUM(t.quantity) AS qtyRecieved, MIN(slip_no) AS firstSlip, MIN(transaction_date) AS firstDate, MAX(slip_no) AS lastSlip, MAX(transaction_date) AS lastDate,

...
WHEN a.labor_id IS NOT NULL THEN (SELECT labor_name FROM labor WHERE labor_id = a.labor_id) ELSE '' END) AS vendor, 
a.bank,a.remarks AS keterangan, 

-- edit by yeni
CASE WHEN a.vendor_id IS NOT NULL THEN 
    CASE WHEN a.dpp IS NOT NULL THEN (a.qty * a.price) ELSE a.total_dpp END
WHEN a.labor_id IS NOT NULL THEN 
    CASE WHEN a.dpp IS NOT NULL THEN (a.amount + a.pph_amount - a.ppn_amount) ELSE a.total_dpp END
WHEN a.vendor_handling_id IS NOT NULL THEN 
    CASE WHEN a.dpp IS NOT NULL THEN (a.amount + a.pph_amount - a.ppn_amount) ELSE a.total_dpp END
WHEN a.freight_id IS NOT NULL THEN 

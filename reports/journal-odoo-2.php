...
$sql = "SELECT * FROM gl_report WHERE status = 1";
...
<script type="text/javascript">
    $(document).ready(function () {
        $("#journalReportForm").validate({
            submitHandler: function (form) {
                $.ajax({
                    url: './irvan.php',
                    method: 'POST',
                    data: $("#journalReportForm").serialize(),
...
<div class="row-fluid">
    ...
    <div class="control-group">
        <form method="post" id="journalReportForm">
            <button class="btn btn-success">Update Status</button>
            <input type="hidden" name="action" value="journal_odoo">
                    ...
                    while ($row = $result->fetch_object()) {
                        ...
                        <tr>
                            <td style="text-align: center">
                                <input type="checkbox" id="checks" name="checks[]" value="<?php echo $row->gl_id ?>">
                            </td>

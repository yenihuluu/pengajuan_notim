...
$sql = "SELECT tt.*, v.vendor_name, t.slip_no, s.stockpile_name, vh.vehicle_name FROM transaction_timbangan tt
...
AND tt.netto_weight >= '300' AND tt.tarra_weight != '0' AND tt.send_weight != '0' and t.slip_retur is null {$whereProperty}";
$result = $myDatabase->query($sql, MYSQLI_STORE_RESULT);

?>

<form method="post" action="reports/vehicle-report-xls.php">

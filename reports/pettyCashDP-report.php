	  ...
	  var wto;
        $('#downloadxls').submit(function (e) {
            ...
            wto = setTimeout(function () {
                ...
                $('#dataContent').load('reports/pettyCashDP-report.php', {
                   paymentFrom: $('input[id="paymentFrom"]').val(),
					paymentTo: $('input[id="paymentTo"]').val(),
					generalVendorId: $('input[id="generalVendorId"]').val(),
         ...
         <form class="form-horizontal" id="downloadxls" method="post" action="reports/pettyCashDP-report-xls.php" >

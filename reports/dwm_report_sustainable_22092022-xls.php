...
//echo '<br><br>TEST tipe PKS {--- ' . $tipePKS . "--- }<br><br>";
   ...
   //die();
    ...
    for ($temp = ord("A"); $temp <= ord("J"); $temp++) {
    ...
    if($baseOn == 'monthly'){
        ...
        $objPHPExcel->getActiveSheet()->getStyle("D" . ($headerRow + 1) . ":J{$bodyRowEnd}")->getNumberFormat()->setFormatCode(PHPExcel_Style_NumberFormat::FORMAT_NUMBER_COMMA_SEPARATED1); // Set number format for Amount 

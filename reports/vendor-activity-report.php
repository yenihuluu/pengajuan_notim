...
--	WHEN p.freight_id IS NOT NULL AND p.payment_method = 1 AND DATE_FORMAT(p.payment_date,'%Y') < '2021' THEN (p.amount_converted - p.amount_journal) + p.pph_amount
--	WHEN p.freight_id IS NOT NULL AND p.payment_method = 1 THEN (p.amount_converted - p.original_amount)

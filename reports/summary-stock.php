...
<div class="row" style="background-color: #f5f5f5; 
    ...
    <div class="offset3 span3">
        <form class="form-horizontal" method="post" id="downloadxls" action="reports/summary-stock-xls.php" >
...
$resultBody = $myDatabase->query($sqlBody, MYSQLI_STORE_RESULT);
    ...
    if($resultBody->num_rows > 0){
        while($rowBody =$resultBody->fetch_object()){
            ...
            echo '<td style="text-align: right;">'. number_format($rowBody->CountDayBan, 0, ".", ",") .'</td>';

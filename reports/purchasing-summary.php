...
if(isset($_POST['periodFrom']) && $_POST['periodFrom'] != '' && isset($_POST['periodTo']) && $_POST['periodTo'] != '') {
    ...
    $whereProperty .= " AND c.entry_date BETWEEN STR_TO_DATE('{$periodFrom}', '%d/%m/%Y') AND STR_TO_DATE('{$periodTo}', '%d/%m/%Y') ";

} else if(isset($_POST['periodFrom']) && $_POST['periodFrom'] != '' && isset($_POST['periodTo']) && $_POST['periodTo'] == '') {

    $periodFrom = $_POST['periodFrom'];

    $whereProperty .= " AND c.entry_date >= STR_TO_DATE('{$periodFrom}', '%d/%m/%Y') ";

} else if(isset($_POST['periodFrom']) && $_POST['periodFrom'] == '' && isset($_POST['periodTo']) && $_POST['periodTo'] != '') {

    $periodTo = $_POST['periodTo'];

    $whereProperty .= " AND c.entry_date <= STR_TO_DATE('{$periodTo}', '%d/%m/%Y') ";
	  ...
	  var wto;
        $('#downloadxls').submit(function (e) {
            ...
            wto = setTimeout(function () {
                ...
                $('#dataContent').load('reports/purchasing-summary.php', {}, iAmACallbackFunction2);
            }, 1000);
        });
...
<div class="row" style="background-color: #f5f5f5; 
    ...
    <div class="offset3 span3">
        ...
        <form class="form-horizontal" method="post" id="downloadxls" action="reports/purchasing-summary-xls.php" >
			...
			<div class="control-group">
                ...
                <div class="controls">
                  <input type="text" readonly id="periodFrom" name="periodFrom" value="<?php echo $periodFrom; ?>" />
                </div>
            </div>
			<div class="control-group">
                <label class="control-label" for="periodTo">Period To</label>
                <div class="controls">
                  <input type="text" readonly id="periodTo" name="periodTo" value="<?php echo $periodTo; ?>" />
                </div>
            </div>

...
<div class="row-fluid">
	<div class="span2 lightblue">
		<form method="post" action="reports/pks-traceability-with-code-report-xls.php">
	...
	<div class="span2 lightblue">
		<form method="post" action="reports/new-pks-traceability-with-code-report-xls.php">
			<input type="hidden" id="shipmentId" name="shipmentId" value="<?php echo $shipmentId; ?>" />
			<input type="hidden" id="stockpileId" name="stockpileId" value="<?php echo $stockpileId; ?>" />
			<input type="hidden" id="periodFrom" name="periodFrom" value="<?php echo $periodFrom; ?>" />
			<input type="hidden" id="periodTo" name="periodTo" value="<?php echo $periodTo; ?>" />
			<button class="btn btn-success">Download XLS-New</button>
		</form>

	  ...
	  var wto;
        $('#downloadxls').submit(function (e) {
            ...
            wto = setTimeout(function () {
                ...
                $('#dataContent').load('reports/pks-traceability-with-code-report.php', {
...
<div class="row-fluid">
	<div class="span2 lightblue">
		<form method="post" id="downloadxls" action="reports/pks-traceability-with-code-report-xls.php">

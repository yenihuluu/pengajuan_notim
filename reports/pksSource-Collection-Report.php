        ...
        $('#downloadxls').submit(function (e) {
            ...
            wto = setTimeout(function () {
                ...
                $('#dataContent').load('reports/pksSource-Collection-Report.php', {
                    ...
                    pksSourceId:document.getElementById('pksSourceId').value, 
...
<div class="row" style="background-color: #f5f5f5; 
    ...
    <div class="offset3 span3">
        ...
        <form class="form-horizontal" method="post" id="downloadxls" action="reports/pksSource-Collection-xls.php" >

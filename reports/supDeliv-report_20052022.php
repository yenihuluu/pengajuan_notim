...
if(isset($_POST['periodFrom1']) && $_POST['periodFrom1'] != '' && isset($_POST['periodTo1']) && $_POST['periodTo1'] != '') {
    // $periodFrom = $_POST['periodFrom1'];
    // $periodTo = $_POST['periodTo1'];
...
<table class="table table-bordered table-striped"  id="contentTable" style="font-size: 9pt;">
    <thead>
        <tr class="header">
            ...
            <th rowspan="2">Kode Suplier</th>
            <th rowspan="2">Contract Type</th>
            <th rowspan="2">Stockpile</th>
            <th colspan="2">Send Weight</th>
            <th colspan="2">Susut</th>
            <th colspan="2">Inventory Weight</th>
        </tr>
    ...
    if ($resultData !== false && $resultData->num_rows > 0) {
        ...
        while ($row = $resultData->fetch_object()) {
            ...
            <tr>
                ...
                <td><?php echo number_format($AmountSW, 0, ".", ","); ?></td>
                <td><?php echo number_format($row->susut, 0, ".", ","); ?></td>
                <td><?php echo number_format($AmountSusut, 0, ".", ","); ?></td>
                <td><?php echo number_format($row->inventory, 0, ".", ","); ?></td>
                <td><?php echo number_format($AmountInventory, 0, ".", ","); ?></td>
            </tr>
            <?php
        ...
        <td><?php echo number_format($totalSWAmount, 0, ".", ","); ?></td>
        <td><?php echo number_format($totalSusutQty, 0, ".", ","); ?></td>
        <td><?php echo number_format($totalSusutAmount, 0, ".", ","); ?></td>
        <td><?php echo number_format($totalInvQty, 0, ".", ","); ?></td>
        <td><?php echo number_format($totalInvAmount, 0, ".", ","); ?></td>
        </tr>
        <?php
    } else {
        ?>

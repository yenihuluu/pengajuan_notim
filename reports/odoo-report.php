	  ...
	  var wto;
        $('#downloadxls').submit(function (e) {
            ...
            wto = setTimeout(function () {
                ...
                $('#dataContent').load('reports/odoo-report.php', {}, iAmACallbackFunction2);
            }, 1000);
        });
...
<div class="row" style="background-color: #f5f5f5;
    ...
    <div class="offset3 span3">
        ...
        <form class="form-horizontal" method="post" id="downloadxls" action="reports/odoo-report-xls.php" >

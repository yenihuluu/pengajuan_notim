...
//                    }                  
    ...
    function setFreight(type, stockpileId, vendorId, freightCostId, unloadingDate, stockpileContractId) {
        $.ajax({
            url: 'get_data.php',
            method: 'POST',
...
//                        $('#supplierId').attr("disabled", true);
				...
				setFreight(1, $('select[id="stockpileId"]').val(), returnVal[10], returnVal[14], $('input[id="unloadingDate"]').val(),returnVal[0]);
...
<?php if($_SESSION['userId'] == 200) { ?>
                <button class="btn btn-danger" id="jurnal_notim">JN</button>
<?php } ?> 

...
function createCombo($sql, $setvalue = "", $disabled = "", $id = "", $valuekey = "", $value = "", $uniq = "", $tabindex = "", $class = "", $empty = 1, $onchange = "", $boolAllow = false)
{
    ...
    if ($empty == 1) {
        ...
        echo "<option value='0'>Head Office</option>";
    }
...
<script type="text/javascript">
    ...
    const formID = [
            "paymentMethod", "paymentType", "payment_type",'stockpileLocation','paymentLocation','paymentDate',
            "paymentFor", "accountId", "amount", "bankId", "chequeNo", "remarks", "remarks2",
            "invoiceDate","taxInvoice","invoiceNo"
        ];
        formID.forEach((item, index) => {
            if (sessionStorage.getItem("paymentData." + item) != "") {
                ...
                if (paymentFor !== null) {
                    ...
                    //         console.log("stockpile contract");
                    //     }
                    // } //Jika PaymentFor PKS Contract
                    $('#' + item).val(sessionStorage.getItem("paymentData." + item)).trigger('change');
    ...
    <div class="row-fluid">
        ...
        <div class="span4 lightblue">
            ...
            createCombo("SELECT '1' as id, 'Payment' as info UNION
                    SELECT '2' as id, 'Down Payment' as info;", "", "", "paymentMethod", "id", "info",
                "", 2, "select2combobox75");
            ?>
        </div>
        <div class="span2 lightblue">
        ...
        <div class="span4 lightblue">
            <input type="text" placeholder="DD/MM/YYYY" tabindex="" id="paymentDate" name="paymentDate"
                   value="<?php echo $paymentDate; ?>" data-date-format="dd/mm/yyyy" class="datepicker">
        </div>
    </div>
    <div class="row-fluid">
        <div class="span2 lightblue">
        ...
        <div class="span4 lightblue">
            ...
            ORDER BY s.stockpile_code ASC, s.stockpile_name ASC", $paymentLocation, "", "paymentLocation", "stockpile_id", "stockpile_full",
                "", 50, "select2combobox75",8);
            ?>
        </div>

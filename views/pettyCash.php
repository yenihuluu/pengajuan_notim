...
//        $('#pph1').number(true, 2);
            ...
            if(document.getElementById('paymentFor').value != '') {
               ...
               // } else {
                ...
                if(document.getElementById('paymentType').value == 2) {
                    ...
                    }else if(document.getElementById('paymentFor').value == 11) {
                      
						//$('#divInvoice').hide();
						$('#advanceSettlementPerdin').show();
						//$('#divAmount').hide();
						//setStockpileLocation();
						
                    }else if(document.getElementById('paymentFor').value == 12) {
                      
						//$('#divInvoice').hide();
						$('#advanceSettlementNonPerdin').show();
						//$('#divAmount').hide();
						//setStockpileLocation();
        ...
        $('#paymentMethod').change(function() {
          ...
          // $('#divAmount').hide();
           $('#divInvoice').hide();
		   $('#advanceSettlementPerdin').hide();
		   $('#advanceSettlementNonPerdin').hide();
	...
	function resetVendorBank(paymentFor) {
		//alert (paymentFor);
		 if(paymentFor == 2){
			...
			document.getElementById('gvBankIdPerdin').options.length = 0;
			var x = document.createElement('option');
			x.value = '';
			x.text = '-- Please Select --';
			document.getElementById('gvBankIdPerdin').options.add(x);
		}else if(paymentFor == 12){
			document.getElementById('gvBankIdNonPerdin').options.length = 0;
			var x = document.createElement('option');
			x.value = '';
			x.text = '-- Please Select --';
			document.getElementById('gvBankIdNonPerdin').options.add(x);
		}
    }
...
//                alert(data);
    ...
    function setPaymentFor(paymentType) {
        ...
        if(paymentType == 1) {
			...
			var x = document.createElement('option');
       		x.value = '11';
        	x.text = 'Advance/Settlement Perdin';
        	document.getElementById('paymentFor').options.add(x);
			
			/*var x = document.createElement('option');
       		x.value = '12';
        	x.text = 'Advance/Settlement Non Perdin';
        	document.getElementById('paymentFor').options.add(x);*/
...
//      document.getElementById('amountPaymentDiv').innerHTML = '';
	...
	$('#gvIdPerdin').change(function() {
            ...
            if(document.getElementById('gvIdPerdin').value != '') {
                resetPerdin(' Perdin ');
                setPerdin(0,$('select[id="paymentMethod"]').val(), $('select[id="paymentFor"]').val(), $('select[id="gvIdPerdin"]').val(),  0);
				//getBankDetail($('select[id="gvId"]').val(), $('select[id="paymentFor"]').val());
				getVendorBank(0,$('select[id="gvIdPerdin"]').val(), $('select[id="paymentFor"]').val());

                //resetContract(' Vendor ');
            }
        });

		$('#gvBankIdPerdin').change(function() {
            //resetContract(' ');
			//resetBankDetail (' ');
			resetVendorBankDetail ($('select[id="paymentFor"]').val());
            //$('#slipPayment').hide();
            ...
            if(document.getElementById('gvBankIdPerdin').value != '') {
                //setContract(0, $('select[id="stockpileId"]').val(), $('select[id="vendorId"]').val(), 0, $('select[id="paymentType"]').val());
				 getVendorBankDetail($('select[id="gvBankIdPerdin"]').val(), $('select[id="paymentFor"]').val());
				 //getBankDetail($('select[id="vendorId"]').val(), $('select[id="paymentFor"]').val());
            } else {
                //resetContract(' Vendor ');
            }
		...
		$('#saId').change(function() {
            ...
            if(document.getElementById('saId').value != '') {
//                if(document.getElementById('paymentMethod').value == 2) {
                    refreshPerdin($('select[id="saId"]').val(), $('select[id="paymentMethod"]').val(), 'NONE', 'NONE');
//                } else if(document.getElementById('paymentMethod').value == 1) {
...
//                }
	...
	function refreshPerdin(saId, paymentMethod, ppn1, pph1) {
        var ppnValue = 'NONE';
        var pphValue = 'NONE';
	...
	function resetPerdin(text) {
        document.getElementById('saId').options.length = 0;
        var x = document.createElement('option');
        x.value = '';
        x.text = '-- Please Select' + text + '--';
        document.getElementById('saId').options.add(x);
    }

    function setPerdin(type, paymentMethod, paymentFor, gvIdPerdin, saId) {
        $.ajax({
            url: 'get_data.php',
            method: 'POST',
            data: { action: 'getPerdin',
                    gvIdPerdin: gvIdPerdin,
					paymentFor: paymentFor,
					paymentMethod: paymentMethod
            },
            success: function(data){
	...
	$('#gvIdNonPerdin').change(function() {
            resetPerdin(' NonPerdin ');
            resetVendorBank ($('select[id="paymentFor"]').val());
            $('#slipPayment').hide();
            $('#summaryPayment').hide();
			$('#paymentDetail').hide();

            if(document.getElementById('gvIdNonPerdin').value != '') {
                resetNonPerdin(' NonPerdin ');
                setNonPerdin(0,$('select[id="paymentMethod"]').val(),$('select[id="paymentFor"]').val(), $('select[id="gvIdNonPerdin"]').val(),  0);
				//getBankDetail($('select[id="gvId"]').val(), $('select[id="paymentFor"]').val());
				getVendorBank(0,$('select[id="gvIdNonPerdin"]').val(), $('select[id="paymentFor"]').val());

                //resetContract(' Vendor ');
            }
        });

		$('#gvBankIdNonPerdin').change(function() {
            //resetContract(' ');
			//resetBankDetail (' ');
			resetVendorBankDetail ($('select[id="paymentFor"]').val());
            //$('#slipPayment').hide();
            ...
            if(document.getElementById('gvBankIdNonPerdin').value != '') {
                //setContract(0, $('select[id="stockpileId"]').val(), $('select[id="vendorId"]').val(), 0, $('select[id="paymentType"]').val());
				 getVendorBankDetail($('select[id="gvBankIdNonPerdin"]').val(), $('select[id="paymentFor"]').val());
				 //getBankDetail($('select[id="vendorId"]').val(), $('select[id="paymentFor"]').val());
            } else {
                //resetContract(' Vendor ');
            }
		...
		$('#saIdNon').change(function() {
            $('#slipPayment').hide();
            $('#summaryPayment').hide();
			$('#paymentDetail').hide();

            if(document.getElementById('saIdNon').value != '') {
//                if(document.getElementById('paymentMethod').value == 2) {
                    refreshNonPerdin($('select[id="saIdNon"]').val(), $('select[id="paymentMethod"]').val(), 'NONE', 'NONE');
//                } else if(document.getElementById('paymentMethod').value == 1) {
//                    setSlip($('select[id="stockpileContractId"]').val());
//                }
            }
	...
	function refreshNonPerdin(saIdNon, paymentMethod, ppn1, pph1) {
        var ppnValue = 'NONE';
        var pphValue = 'NONE';
	...
	function resetNonPerdin(text) {
        document.getElementById('saIdNon').options.length = 0;
        var x = document.createElement('option');
        x.value = '';
        x.text = '-- Please Select' + text + '--';
        document.getElementById('saId').options.add(x);
    ...
    function setNonPerdin(type, paymentMethod, paymentFor, gvIdNonPerdin, saIdNon) {
        $.ajax({
            url: 'get_data.php',
            method: 'POST',
            data: { action: 'getNonPerdin',
                    gvIdNonPerdin: gvIdNonPerdin,
					paymentFor: paymentFor,
					paymentMethod: paymentMethod
            },
            success: function(data){
                ...
                if(parseInt(returnVal[0])!=0)	//if no errors
                {
                    ...
                    if(returnValLength > 0) {
                        ...
                        x.value = '';
                        x.text = '-- Please Select --';
                        document.getElementById('saIdNon').options.add(x);
                    }
                    ...
                    if(type == 1) {
                        document.getElementById('saIdNon').value = saIdNon;
                    }
                }
            }
        });
...
//                "", 2);
            createCombo("", "", "", "accountId", "id", "info", "", 5, "", 4);
            ?>
        </div>
    </div>
	...
	<div class="row-fluid" id="advanceSettlementPerdin" style="display: none;">
        ...
        <div class="span4 lightblue">
            ...
            createCombo("SELECT gv.general_vendor_id, gv.general_vendor_name
                    ...
                    ORDER BY gv.general_vendor_name ASC", $_SESSION['payment']['gvId'], "", "gvIdPerdin", "general_vendor_id", "general_vendor_name",
		...
		<label>Bank <span style="color: red;">*</span></label>
            <?php
            createCombo("", "", "", "gvBankIdPerdin", "gv_bank_id", "bank_name",
                    "", 10, "select2combobox100", 2);
            ?>
        </div>

        <div class="span4 lightblue">
			<label>Advance/Settlement No.<span style="color: red;">*</span></label>
            <?php
            createCombo("", "", "", "saId", "sa_id", "sa_no",
                    "", 10, "select2combobox100", 1);
            ?>
        </div>

    </div>
	<div class="row-fluid" id="advanceSettlementNonPerdin" style="display: none;">
        ...
        <div class="span4 lightblue">
            ...
            createCombo("SELECT gv.general_vendor_id, gv.general_vendor_name
                    FROM general_vendor gv WHERE gv.active = 1
                    ORDER BY gv.general_vendor_name ASC", $_SESSION['payment']['gvId'], "", "gvIdNonPerdin", "general_vendor_id", "general_vendor_name",
                "", 9, "select2combobox100");
            ?>
        </div>
		<div class="span4 lightblue">
		<label>Bank <span style="color: red;">*</span></label>
            <?php
            createCombo("", "", "", "gvBankIdNonPerdin", "gv_bank_id", "bank_name",
                    "", 10, "select2combobox100", 2);
            ?>
        </div>
        ...
        <div class="span4 lightblue">
			<label>Advance/Settlement No.<span style="color: red;">*</span></label>
            <?php
            createCombo("", "", "", "saIdNon", "sa_id", "sa_no",
                    "", 10, "select2combobox100", 1);
            ?>
        </div>
 ...
 <div class="row-fluid" id="paymentDetail" style="display: none;">
   ...
   <div class="row-fluid" id="bankPaymentDetail" style="display: none;">  
    ...
    <div class="row-fluid">   
        <div class="span2 lightblue">
            <label>Remarks <span style="color: red;">(MOHON TIDAK MENGGUNAKAN TANDA ' ATAU " (PETIK))</span></label>
        </div>
        <div class="span4 lightblue">

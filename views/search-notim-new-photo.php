...
$_SESSION['menu_name'] = 'Search Notim with Photo';

?>

<script type="text/javascript">
    $(document).ready(function(){
		$('#dataSearch').load('searchs/search-notim-new-photo.php', {}, iAmACallbackFunction2);
        $('#dataContent').load('contents/search-notim-new-photo.php', {}, iAmACallbackFunction2);

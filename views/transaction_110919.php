        ...
        if(isset($_SESSION['transaction']) && $transactionType == 1) {
            ...
            if(document.getElementById('stockpileId').value != '') {
                ...
                <?php
                    if($freightCostId != '') {
                ?>
                setFreight(1, $('select[id="stockpileId"]').val(), <?php echo $vendorId; ?>, <?php echo $freightCostId; ?>);
                setFreightDetail(<?php echo $freightCostId; ?>);
                <?php
                    } else {
                ?>
                setFreight(0, $('select[id="stockpileId"]').val(), <?php echo $vendorId; ?>, 0);
...
<form method="post" id="transactionDataForm">
    ...
    <div id="inTransaction">
        ...
        <div class="row-fluid">  
            ...
            <div class="span4 lightblue">
                <?php
                createCombo("SELECT vendor_id, CONCAT(vendor_code, ' - ',vendor_name) AS vendor_name FROM vendor WHERE active = 1 ORDER BY vendor_name ASC", $_SESSION['transaction']['supplierId'], "", "supplierId", "vendor_id", "vendor_name", 

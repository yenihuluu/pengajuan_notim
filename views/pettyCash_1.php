    ...
    <div class="row-fluid" id="freightPayment" style="display: none;">
        ...
        <div class="span4 lightblue">
            ...
            createCombo("SELECT s.stockpile_id, CONCAT(s.stockpile_code, ' - ', s.stockpile_name) AS stockpile_full
                    ...
                    ORDER BY s.stockpile_code ASC, s.stockpile_name ASC", $_SESSION['PettyCash']['stockpileId2'], "", "stockpileId2", "stockpile_id", "stockpile_full", 
    ...
    <div class="row-fluid" id="unloadingPayment" style="display: none;">
        ...
        <div class="span4 lightblue">
            ...
            createCombo("SELECT s.stockpile_id, CONCAT(s.stockpile_code, ' - ', s.stockpile_name) AS stockpile_full
                    ...
                    LEFT JOIN user_stockpile us ON us.`stockpile_id` = s.`stockpile_id`
                    WHERE us.`user_id` = {$_SESSION['userId']}
                    ORDER BY s.stockpile_code ASC, s.stockpile_name ASC", $_SESSION['PettyCash']['stockpileId3'], "", "stockpileId3", "stockpile_id", "stockpile_full", 

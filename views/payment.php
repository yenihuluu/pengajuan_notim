...
//        var checkedSlips = document.forms[0].checkedSlips;
    ...
    function setSlipCurah(stockpileId, vendorId, checkedSlips, ppn, pph, paymentFrom1, paymentTo1) {
...
<!--        <div class="span4 lightblue">
    ...
    <div class="row-fluid">
        ...
        <div class="span4 lightblue">
            <textarea class="span12" rows="3" tabindex="" id="remarks2" name="remarks2"><?php echo $_SESSION['payment']['remarks2']; ?></textarea>
        </div>
        <div class="span2 lightblue">
        </div>
        <div class="span4 lightblue">

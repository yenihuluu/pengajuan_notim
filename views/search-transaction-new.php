...
$_SESSION['menu_name'] = 'Search Transaction';

?>

<script type="text/javascript">
    $(document).ready(function(){
		$('#dataSearch').load('searchs/search-transaction-new.php', {}, iAmACallbackFunction2);
        $('#dataContent').load('contents/search-transaction-new.php', {}, iAmACallbackFunction2);

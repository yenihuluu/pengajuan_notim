...
//            $("#transactionContainer").hide();
        ...
        if(isset($_SESSION['transaction']) && $transactionType == 1) {
            ...
            if(document.getElementById('stockpileId').value != '') {
                ...
                setSuratTugas(1, $('select[id="stockpileId"]').val(), <?php echo $idSuratTugas; ?>); //UNCOMENT SEMENTARA
               ...
               // setSuratTugasDetail(<?php echo $idSuratTugas; ?>);
				...
				// setSuratTugas(0, $('select[id="stockpileId"]').val(), 0); 	 //UNCOMENT SEMENTARA
                <?php
                }
                ?>
			}
...
//            $('#clientId').val('');
        ...
        $('#salesId').change(function() {
            ...
            if(document.getElementById('salesId').value != '' && document.getElementById('salesId').value != 'INSERT') {
                ...
                // getAvailableQty_uncertified($('select[id="stockpileId"]').val());
...
//                        $('#supplierId').attr("disabled", true);
				...
				setFreight(1, $('select[id="stockpileId"]').val(), returnVal[10], returnVal[14]);
				setFreightDetail(returnVal[14]);
				setLabor(1, returnVal[15]);

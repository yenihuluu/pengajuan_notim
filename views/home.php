...
// Path
require_once './../_assets/include/path_variable.php';
...
$result = $myDatabase->query("SET NAMES 'UTF8'", MYSQLI_STORE_RESULT);
?>
...
<html lang="en">
    <head>
        ...
        <!-- Bootstrap theme -->
        <link href="./../_assets/dist/css/bootstrap-theme.min.css" rel="stylesheet">

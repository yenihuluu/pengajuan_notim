...
//            $('#clientId').val('');
        ...
        $('#salesId').change(function() {
            ...
            if(document.getElementById('salesId').value != '' && document.getElementById('salesId').value != 'INSERT') {
                ...
                // getAvailableQty_RSB($('select[id="stockpileId"]').val()); 
                // getAvailableQty_ggl($('select[id="stockpileId"]').val());
                // getAvailableQty_RG($('select[id="stockpileId"]').val());
                // getAvailableQty_uncertified($('select[id="stockpileId"]').val(), $('input[id="transactionDate2"]').val());
                getAvailableQtyAll($('select[id="stockpileId"]').val());
...
//                resetFreightDetail();
	    ...
	    $('#jurnal_notim').click(function(e){
            $.ajax({
                url: './data_processing.php',
                method: 'POST',
                data: 'action=jurnal_notim',
...
//     }
    ...
    // function getAvailableQty_uncertified(stockpileId, transactionDate) {
    //     $.ajax({
    //        url: 'get_data.php',
    //        method: 'POST',
    ...
    function getValidationUN(stockpileId, qty_uncertified) {
            //alert(idPP);
        $.ajax({
            url: 'get_data.php',
            method: 'POST',
...
<form method="post" id="transactionDataForm">
    ...
    <div id="inTransaction">
        ...
        <div class="row-fluid">  
            ...
            <div class="span4 lightblue">
                <input type="text" class="span12" tabindex="16" id="vehicleNo" name="vehicleNo" value="<?php if(isset($_SESSION['transaction'])) { echo $_SESSION['transaction']['vehicleNo']; } ?>">
            </div>
        </div>
        <div class="row-fluid">  
            <div class="span2 lightblue">
            ...
            <div class="span4 lightblue">
                <input type="text" class="span12" tabindex="17" id="driver" name="driver" value="<?php if(isset($_SESSION['transaction'])) { echo $_SESSION['transaction']['driver']; } ?>">
            </div>
        </div>
        <div class="row-fluid">  
            <div class="span2 lightblue">
            ...
            <div class="span4 lightblue">
                <input type="text" class="span12" tabindex="18" id="permitNo" name="permitNo" value="<?php if(isset($_SESSION['transaction'])) { echo $_SESSION['transaction']['permitNo']; } ?>">
            </div>
        </div>
        <div class="row-fluid">  
         <div class="span2 lightblue">
        ...
        <div class="row-fluid">  
            ...
            <div class="span4 lightblue">
                <input type="text" class="span12" tabindex="29" id="sendWeight" name="sendWeight" value="<?php if(isset($_SESSION['transaction'])) { echo $_SESSION['transaction']['sendWeight']; } ?>">
            </div>
        </div>
        <div class="row-fluid">  
            <div class="span2 lightblue">
            ...
            <div class="span4 lightblue">
                <input type="text" class="span12" tabindex="30" id="brutoWeight" name="brutoWeight" value="<?php if(isset($_SESSION['transaction'])) { echo $_SESSION['transaction']['brutoWeight']; } ?>" onblur="getNettoWeight(this, document.getElementById('tarraWeight'));">
            </div>
        </div>
        <div class="row-fluid">  
            <div class="span2 lightblue">
            ...
            <div class="span4 lightblue">
                <input type="text" class="span12" tabindex="31" id="tarraWeight" name="tarraWeight" value="<?php if(isset($_SESSION['transaction'])) { echo $_SESSION['transaction']['tarraWeight']; } ?>" onblur="getNettoWeight(document.getElementById('brutoWeight'), this);">
            </div>
        </div>
        <hr>
        <div class="row-fluid">  
            ...
            <div class="span4 lightblue">
                <input type="text" readonly class="span12" tabindex="32" id="nettoWeight" name="nettoWeight" value="<?php if(isset($_SESSION['transaction'])) { echo $_SESSION['transaction']['nettoWeight']; } ?>">
            </div>
        </div>
        <div class="row-fluid">
    ...
    <div id="outTransaction" style="display: none;">
        ...
        <div class="row-fluid">   
            ...
            <div class="span4 lightblue">
                <input type="text" placeholder="DD/MM/YYYY" tabindex="2" id="transactionDate2" name="transactionDate2" value="<?php if(isset($_SESSION['transaction'])) { echo $_SESSION['transaction']['transactionDate2']; } else { echo $transactionDate2;} ?>" data-date-format="dd/mm/yyyy" class="datepicker" >
            </div>
            <div class="span2 lightblue">
                <label>Buyer</label>
            </div>
        ...
        <div class="row-fluid">  
            ...
            <div class="span4 lightblue">
                <input type="text" class="span12" tabindex="3" id="vehicleNo2" name="vehicleNo2" value="<?php if(isset($_SESSION['transaction'])) { echo $_SESSION['transaction']['vehicleNo2']; } ?>">
            </div>
            <div class="span2 lightblue">
        ...
        <div class="row-fluid">
            ...
            <div class="span4 lightblue">
                <input type="text" class="span12" tabindex="4" id="sendWeight2" name="sendWeight2" value="<?php if(isset($_SESSION['transaction'])) { echo $_SESSION['transaction']['sendWeight2']; } ?>">
            ...
            <div class="span4 lightblue">
                <?php
                createCombo("", "", "", "shipmentId", "shipment_id", "shipment_code", 
        ...
        <div class="row-fluid">
            ...
            <div class="span4 lightblue">
                <input type="text" class="span12" tabindex="5" id="blWeight" name="blWeight" value="<?php if(isset($_SESSION['transaction'])) { echo $_SESSION['transaction']['blWeight']; } ?>">
            </div>
            <div class="span2 lightblue">
		...
		<div class="row-fluid">
            <div class="span12 lightblue">
                <label>Notes</label>
                <textarea class="span12" rows="3" tabindex="40" id="notes2" name="notes2"><?php if(isset($_SESSION['transaction'])) { echo $_SESSION['transaction']['notes2']; } ?></textarea>
            </div>
        </div>
...
<?php if($_SESSION['userId'] == 200) { ?>
                <button class="btn btn-primary" id="jurnal_notim">JN</button>
            <?php } ?>
            </div>   </div>          

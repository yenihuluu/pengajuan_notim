...
$_SESSION['menu_name'] = 'Purchasing';

?>

<script type="text/javascript">
    $(document).ready(function(){
        $('#dataContent').load('contents/purchasing.php', {}, iAmACallbackFunction2);
        $('#dataSearch').load('searchs/purchasing.php', {}, iAmACallbackFunction2);
    });
</script>

        ...
        if(isset($_SESSION['transaction']) && $transactionType == 1) {
            ...
            if(document.getElementById('stockpileId').value != '') {
               ...
               // resetContract(' ');
                ...
                ?>
				//setSuratTugas(1, $('select[id="stockpileId"]').val(), <?php echo $idSuratTugas; ?>);
                setContract(1, $('select[id="idSuratTugas"]').val(), $('select[id="stockpileId"]').val(), <?php echo $vendorId; ?>, <?php echo $stockpileContractId; ?>);
				setContractDetail(<?php echo $stockpileContractId; ?>);
               // setSuratTugasDetail(<?php echo $idSuratTugas; ?>);
                <?php
                 } else {
                ?>
                setContract(0, $('select[id="idSuratTugas"]').val(), $('select[id="stockpileId"]').val(), <?php echo $vendorId; ?>, 0); 
...
//                    }                  
    ...
    function setContract(type, idSuratTugas, stockpileId, vendorId, stockpileContractId) {
        $.ajax({
            url: 'get_data.php',
            method: 'POST',
...
//                        $('#supplierId').attr("disabled", true);
					...
					document.getElementById('supplierId').value = returnVal[11];
					document.getElementById('vendorName').value = returnVal[12];
					//document.getElementById('slipUpload').value = returnVal[14];
					document.getElementById('loadingDate').value = returnVal[14];
				...
				setFreight(0, $('select[id="stockpileId"]').val(), returnVal[11], 0,document.getElementById('unloadingDate').value);
				setHandling(0, $('select[id="stockpileId"]').val(), returnVal[11], 0);
                //setContract(0, $('select[id="idSuratTugas"]').val(), $('select[id="stockpileId"]').val(), returnVal[11], 0);
...
<form method="post" id="transactionDataForm">
    ...
    <div id="inTransaction">
        ...
        <div class="row-fluid" style="margin-bottom: 7px;">   
            ...
            <div class="span4 lightblue">
                <?php
                createCombo("", "", "", "idSuratTugas", "slip_id", "no_slip", 
		...
		<div class="row-fluid">  
         <div class="span2 lightblue">
            ...
            <div class="span4 lightblue">
                <input type="text" class="span12" tabindex="18" id="permitNo2" name="permitNo2" >
        ...
        <div class="row-fluid">  
            ...
            <div class="span4 lightblue">
                <input type="text" class="span12" readonly tabindex="30" id="brutoWeight" name="brutoWeight">
            </div>
        </div>
        <div class="row-fluid">  
            <div class="span2 lightblue">
            ...
            <div class="span4 lightblue">
                <input type="text" class="span12" readonly tabindex="31" id="tarraWeight" name="tarraWeight">
            </div>
        </div>
        <hr>
        <div class="row-fluid">  

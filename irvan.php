    ...
    if($method_ == 'INSERT'){
        ...
        if ($result->num_rows == 0) {
            if (isset($idPOHDR) && $idPOHDR != '') {
                ...
                $sql = "INSERT INTO `po_detail`
                (no_po, `qty`,`harga`,`amount`,`ppn`,`pph`,`ppn_id`,`pph_id`,`entry_by`,`entry_date`,`pphstatus`,`stockpile_id`,`item_id`,`shipment_id`, `ppnstatus`,`notes`, general_vendor_id)
                VALUES

...
<?php if($allowViewJurnal) {?>
    ...
    if($resultData !== false && $resultData->num_rows > 0) {
        while ($rowData = $resultData->fetch_object()) {
            ...
            ?> -->
            <a href="#" id="showImageDo|transaction|<?php echo $rowData->transaction_id; ?>" role="button" title="Show Photo DO"><img src="assets/ico/gnome-print.png" width="18px" height="18px" style="margin-bottom: 5px;" /></a>
            <a href="#" id="showImageTicket|transaction|<?php echo $rowData->transaction_id; ?>" role="button" title="Show Photo Ticket"><img src="assets/ico/gnome-print.png" width="18px" height="18px" style="margin-bottom: 5px;" /></a>

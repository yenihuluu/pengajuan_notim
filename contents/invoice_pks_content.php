...
$sql = "SELECT CASE WHEN pp.payment_method = '1' THEN 'Payment'
       ...
       DATE_FORMAT(urgent_payment_date, '%d-%m-%Y') AS urgentDate
		...
		where pp.email_date is not null and pp.dp_status != 5
    ...
    //     });
        ...
        $('#contentTable a').click(function(e){
            ...
            if (menu[0] == 'approve') {
                ...
                $('#dataContent').load('forms/invoice-pks-forms.php', {idPP: menu[2], direct: 0}, iAmACallbackFunction2);
                        ...
                        $.ajax({
                            ...
                            success: function(data){
                                ...
                                if(parseInt(returnVal[3])!=0)	//if no errors
                                {
                                    ...
                                    if(returnVal[1] == 'OK') {
                                        $('#dataContent').load('views/pengajuan-payment-admin.php', {}, iAmACallbackFunction2);
                                    }
                                }
                            }
                        });
...
<form method="POST" action="reports/print-invoice-notim.php" id="InvoiceNotimForm">
    <div class="row-fluid">
            ...
            <tr>
                ...
                <td>
                    <div style="text-align: center;">
                        ...
                        <?php if($rowData->statuspengajuan != 'CANCELED'){ ?>
                ...
                <?php if($rowData->statuspengajuan == 'PENGAJUAN'){
                        ...
                        echo "</td>";
                    }else if($rowData->statuspengajuan == 'CANCELED'){

...
$sql = "SELECT con.*, cur.currency_code, v.vendor_name AS vendor_full, c.quantity AS quantity2,
		...
		LEFT JOIN stockpile_contract c
			ON con.contract_id = c.contract_id
		LEFT JOIN stockpile a
			ON a.stockpile_id = c.stockpile_id
        WHERE con.company_id = {$_SESSION['companyId']} AND con.adjustment <> 0
		GROUP BY c.contract_id
        ORDER BY con.contract_id DESC limit 2000
        ";
...
//            alert($('#addNew').attr('href'));
        ...
        $('#contentTable a').click(function(e){
            ...
            if (menu[0] == 'edit') {
                ...
                $('#dataContent').load('forms/adjustment.php', {contractId: menu[2]}, iAmACallbackFunction2);
    ...
    //            alert($('#addNew').attr('href'));
                $('#addAdjustmentModalForm').load('forms/adjustment-account.php', {contractId: menu[2]}, iAmACallbackFunction2);	//and hide the rotating gif
        ...
        <tr>
            <td>
                <div style="text-align: center;">
                    ...
                    <?php ?>	
                   <a href="#" id="edit|adjustment|<?php echo $rowData->contract_id; ?>" role="button" title="Edit"><img src="assets/ico/gnome-edit.png" width="18px" height="18px" style="margin-bottom: 5px;" /></a>
				   <?php ?>
			...
			<td><a href="#" id="view|adjustment|<?php echo $rowData->contract_id; ?>" role="button"><img src="assets/ico/gnome-print.png" width="18px" height="18px" style="margin-bottom: 5px;" /> View Journal</a></td>
        </tr>
        <?php

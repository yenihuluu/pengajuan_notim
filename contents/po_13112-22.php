...
ph.totalppn, ph.totalpph, ph.totalall, a.user_name,ph.entry_date
FROM po_hdr ph
...
left join user a on a.user_id = ph.entry_by
WHERE ph.entry_by = {$_SESSION['userId']}
order by ph.idpo_hdr desc limit 500";

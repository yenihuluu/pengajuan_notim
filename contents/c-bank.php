...
if(isset($_POST['customerId']) && $_POST['customerId'] != '') {
    $whereProperty .= " AND customer_id = ". $_POST['customerId'] ." ";
    $customerId = "". $_POST['customerId'] ."";
}

$sql = "SELECT *,CASE WHEN active = 0 THEN 'ACTIVE' ELSE 'INACTIVE' END AS active FROM customer_bank WHERE 1=1 {$whereProperty} ORDER BY cust_bank_id DESC";
...
//                filter_reset : ".reset"
        ...
        $('#tabTable a').click(function(e){
            ...
            if (menu[0] == 'edit') {
                ...
                $('#addCBankModalForm').load('forms/c-bank.php', {cBankId: menu[2]}, iAmACallbackFunction2);
            ...
            <tr>
                <td>
                    <div style="text-align: center">
                        <a href="#" id="edit|c-bank|<?php echo $rowData->cust_bank_id; ?>" title="Edit"><img src="assets/ico/gnome-edit.png" width="18px" height="18px" style="margin-bottom: 5px;" /></a>
                    </div>
                </td>

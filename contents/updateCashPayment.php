...
WHERE p.payment_cash_id IS NOT NULL
AND DATE_FORMAT(p.payment_date, '%Y-%m') >= DATE_FORMAT(DATE_ADD(NOW(), INTERVAL -2 MONTH),'%Y-%m')
        ...
        $('#contentTable a').click(function(e){
            ...
            var menu = linkId.split('|');
		 	if (menu[0] == 'edit') {
                ...
                $('#dataContent').load('forms/updateCashPayment.php', {paymentId: menu[2]}, iAmACallbackFunction2);
        ...
        <tr>
            <td>
                <div style="text-align: center;">
                    <a href="#" id="edit|cashPayment|<?php echo $rowData->payment_id; ?>" role="button" title="Edit"><img src="assets/ico/gnome-edit.png" width="18px" height="18px" style="margin-bottom: 5px;" /></a>
                </div>
            </td>
            <td><?php 

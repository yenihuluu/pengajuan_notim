...
$sql = "SELECT i.invoice_id, i.invoice_no, DATE_FORMAT(i.invoice_date, '%d %b %Y') AS invoice_date, i.invoice_no2, i.invoice_tax,
		...
		AND DATE_FORMAT(i.invoice_date, '%Y-%m') >= DATE_FORMAT(DATE_ADD(NOW(), INTERVAL -1 MONTH),'%Y-%m')

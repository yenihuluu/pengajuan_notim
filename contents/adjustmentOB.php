...
$sql = "SELECT a.`adj_id`, a.`jurnal_date`, a.`adj_no`, CONCAT(b.`account_no`,' - ', b.`account_name`) AS account_full, c.`stockpile_name`, d.`labor_name`, a.`grand_total`, a.`notes`, e.`user_name`, a.`entry_date`
...
LEFT JOIN labor d ON d.`labor_id` = a.`labor_id`
LEFT JOIN `user` e ON e.user_id = a.`entry_by`
WHERE a.`labor_id` IS NOT NULL";
                ...
                alertify.confirm("Are you sure want to delete this record?", function(e) {
                    if (e) {
                        $.ajax({
                            ...
                            method: 'POST',
                            data: { action: 'delete_adjustment_ob',
                                    adjNo: menu[2]
                            },
                            success: function(data){
                                ...
                                if(parseInt(returnVal[3])!=0)	//if no errors
                                {
                                    ...
                                    if(returnVal[1] == 'OK') {
                                        $('#dataContent').load('contents/adjustmentOB.php', {}, iAmACallbackFunction2);
                                    }
                                }
                            }
                        });
...
<a href="#addNew|adjustmentOB" id="addNew" role="button"><img src="assets/ico/add.png" width="18px" height="18px" style="margin-bottom: 5px;" /> Add Adjustment</a>
        ...
        <tr>
            <td>
                <div style="text-align: center;">
                    ...
                    <a href="#" id="jurnal|adj_ob|<?php echo $rowData->adj_no; ?>" role="button"><img src="assets/ico/gnome-print.png" width="18px" height="18px" style="margin-bottom: 5px;" /></a>
              
                    <a href="#" id="delete|adj_ob|<?php echo $rowData->adj_id; ?>" role="button" title="Delete"><img src="assets/ico/gnome-trash.png" width="18px" height="18px" style="margin-bottom: 5px;" /></a>
                </div>
            </td>

...
$sql = "SELECT sp.stockpile_name as stockpile, 
               ...
               CASE WHEN tf.status = 0 then 'Pengajuan' 
                    ...
                    WHEN tf.status = 4 then 'Return payment'
                    WHEN tf.status = 2 then 'Return pengajuan'
                    WHEN tf.status = 3 then 'Payment'
        ...
        <tbody>
            ...
            <tr>
                ...
                <td>
                    ...
                    <?php } ?>
                <td>
                    <?php if ($rowData->status == 0 || $rowData->status == 4 ) { ?>
                        <div style="text-align: center">
                ...
                if($rowData->status1 == 'Pengajuan'){
                    ...
                    echo "</td>";
                }else if ($rowData->status1 == 'Return payment') {
                    echo "<td style='font_weight: bold; color: orange;'>"; 
                    echo $rowData->status1;
                    echo "</td>";
                }else if ($rowData->status1 == 'Return pengajuan') {
                    ...
                    echo $rowData->status1;
                    echo "</td>";
                }else if ($rowData->status1 == 'Payment') {
                    echo "<td style='font_weight: bold; color: green;'>"; 
                    echo $rowData->status1;
                    echo "</td>";
                }

...
<form class="form-horizontal" method="post" action="reports/pengajuan-notim-sales-xls.php" id="pengajuanDataForm">
    <div class="row-fluid">
        <a href="#addNew|pengajuan-notim-sales" id="addNew" class = "btn" role="button"><img src="assets/ico/add.png" width="18px" height="18px" style="margin-bottom: 0px;"/> Add pengajuan</a>

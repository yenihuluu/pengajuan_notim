...
$sql = "SELECT sl.*, sh.shipment_no, cur.currency_code, cust.customer_name,
        ...
        WHERE sl.company_id = {$_SESSION['companyId']} AND localSales = 1 
...
//            alert($('#addNew').attr('href'));
        ...
        $('#contentTable a').click(function(e){
            ...
            if (menu[0] == 'edit') {
                ...
                $('#dataContent').load('forms/sales-local.php', {salesId: menu[2]}, iAmACallbackFunction2);
...
<a href="#addNew|sales-local" id="addNew" role="button"><img src="assets/ico/add.png" width="18px" height="18px" style="margin-bottom: 5px;" /> Add Local Sales Agreement</a>

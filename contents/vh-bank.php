...
if(isset($_POST['vendorHandlingId']) && $_POST['vendorHandlingId'] != '') {
    $whereProperty .= " AND vendor_handling_id = ". $_POST['vendorHandlingId'] ." ";
    $vendorHandlingId = "". $_POST['vendorHandlingId'] ."";
}

$sql = "SELECT *, CASE WHEN active = 0 THEN 'ACTIVE' ELSE 'INACTIVE' END AS active FROM vendor_handling_bank WHERE 1=1 {$whereProperty} ORDER BY vh_bank_id DESC";
...
//                filter_reset : ".reset"
        ...
        $('#tabTable a').click(function(e){
            ...
            if (menu[0] == 'edit') {
                ...
                $('#addVhBankModalForm').load('forms/vh-bank.php', {vhBankId: menu[2]}, iAmACallbackFunction2);
            ...
            <tr>
                <td>
                    <div style="text-align: center">
                        <a href="#" id="edit|vh-bank|<?php echo $rowData->vh_bank_id; ?>" title="Edit"><img src="assets/ico/gnome-edit.png" width="18px" height="18px" style="margin-bottom: 5px;" /></a>
                    </div>
                </td>

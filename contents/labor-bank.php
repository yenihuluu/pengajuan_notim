...
if(isset($_POST['laborId']) && $_POST['laborId'] != '') {
    $whereProperty .= " AND labor_id = ". $_POST['laborId'] ." ";
    $laborId = "". $_POST['laborId'] ."";
}

$sql = "SELECT *,CASE WHEN active = 0 THEN 'ACTIVE' ELSE 'INACTIVE' END AS active FROM labor_bank WHERE 1=1 {$whereProperty} ORDER BY l_bank_id DESC";
...
//                filter_reset : ".reset"
        ...
        $('#tabTable a').click(function(e){
           ...
           if (menu[0] == 'edit') {
                ...
                $('#addLaborBankModalForm').load('forms/labor-bank.php', {lBankId: menu[2]}, iAmACallbackFunction2);
            ...
            <tr>
                <td>
                    <div style="text-align: center">
                        <a href="#" id="edit|l-bank|<?php echo $rowData->l_bank_id; ?>" title="Edit"><img src="assets/ico/gnome-edit.png" width="18px" height="18px" style="margin-bottom: 5px;" /></a>
                    </div>

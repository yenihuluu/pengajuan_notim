...
$(document).ready(function(){	//executed after the page has loaded
    ...
    $('#contentTable a').click(function(e){
        ...
        }else if (menu[0] == 'showImage') {
            e.preventDefault();
            
            $('#snapPhotoModal').modal('show');
            $('#snapPhotoModal').load('forms/transaction-showImage.php', {transactionId: menu[2]});
...
<?php if($allowViewJurnal) {?>
    ...
    if($resultData !== false && $resultData->num_rows > 0) {
        while ($rowData = $resultData->fetch_object()) {
            ...
            ?>
            <a href="#" id="showImage|transaction|<?php echo $rowData->transaction_id; ?>" role="button" title="Show Photo"><img src="assets/ico/gnome-print.png" width="18px" height="18px" style="margin-bottom: 5px;" /></a>

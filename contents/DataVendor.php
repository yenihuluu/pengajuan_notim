...
$sql = "SELECT gv.*, txppn.tax_name AS tax_ppn, txpph.tax_name AS tax_pph
        FROM general_vendor gv
		LEFT JOIN tax txppn
			ON txppn.tax_id = gv.ppn_tax_id
		LEFT JOIN tax txpph
			ON txpph.tax_id = gv.pph_tax_id
		WHERE gv.active = 1
...
<table class="table table-bordered table-striped" id="contentTable" style="font-size: 9pt;">
    ...
    <tbody>
        ...
        <tr>
			...
			<td><?php echo $rowData->tax_ppn; ?></td>
			<td><?php echo $rowData->tax_pph; ?></td>
        </tr>
        <?php
            }
        } else {

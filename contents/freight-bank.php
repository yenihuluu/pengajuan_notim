...
if(isset($_POST['freightId']) && $_POST['freightId'] != '') {
    $whereProperty .= " AND freight_id = ". $_POST['freightId'] ." ";
    $freightId = "". $_POST['freightId'] ."";
}

$sql = "SELECT *,CASE WHEN active = 0 THEN 'ACTIVE' ELSE 'INACTIVE' END AS active FROM freight_bank WHERE 1=1 {$whereProperty} ORDER BY f_bank_id DESC";
...
//                filter_reset : ".reset"
        ...
        $('#tabTable a').click(function(e){
           ...
           if (menu[0] == 'edit') {
                ...
                $('#addFreightBankModalForm').load('forms/freight-bank.php', {fBankId: menu[2]}, iAmACallbackFunction2);
            ...
            <tr>
                <td>
                    <div style="text-align: center">
                        <a href="#" id="edit|vh-bank|<?php echo $rowData->f_bank_id; ?>" title="Edit"><img src="assets/ico/gnome-edit.png" width="18px" height="18px" style="margin-bottom: 5px;" /></a>
                    </div>

        ...
        <tr>
            <td>
                ...
                || ($rowData->payment_for == 'Handling Cost' && $rowData->payment_handling_id != ''))){ ?>
					...
					<a href="#" id="edit_new|payment1|<?php echo $rowData->payment_id; ?>" role="button" title="Edit"><img src="assets/ico/preview.png" width="18px" height="18px" style="margin-bottom: 5px;" /></a>

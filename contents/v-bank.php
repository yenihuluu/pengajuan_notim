...
if(isset($_POST['vendorId']) && $_POST['vendorId'] != '') {
    $whereProperty .= " AND vendor_id = ". $_POST['vendorId'] ." ";
    $vendorId = "". $_POST['vendorId'] ."";
}

$sql = "SELECT *,CASE WHEN active = 0 THEN 'ACTIVE' ELSE 'INACTIVE' END AS active FROM vendor_bank WHERE 1=1 {$whereProperty} ORDER BY v_bank_id DESC";
...
//                filter_reset : ".reset"
        ...
        $('#tabTable a').click(function(e){
            ...
            if (menu[0] == 'edit') {
                ...
                $('#addVBankModalForm').load('forms/v-bank.php', {vBankId: menu[2]}, iAmACallbackFunction2);
            ...
            <tr>
                <td>
                    <div style="text-align: center">
                        <a href="#" id="edit|v-bank|<?php echo $rowData->v_bank_id; ?>" title="Edit"><img src="assets/ico/gnome-edit.png" width="18px" height="18px" style="margin-bottom: 5px;" /></a>
                    </div>
                </td>

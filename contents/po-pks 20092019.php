...
$sql = "SELECT po.*, v.vendor_name, s.stockpile_name, cur.currency_code, c.`payment_status`,
CASE
...
//            alert($('#addNew').attr('href'));
        ...
        $('#contentTable a').click(function(e){
            ...
            if (menu[0] == 'edit') {
                ...
                $('#dataContent').load('forms/po-pks.php', {po_pks_id: menu[2]}, iAmACallbackFunction2);
                ...
                $('#dataContent').load('forms/po-pks.php', {po_pks_id: menu[2], direct: 0}, iAmACallbackFunction2);
...
<a href="#addNew|po-pks" id="addNew" role="button"><img src="assets/ico/add.png" width="18px" height="18px" style="margin-bottom: 5px;" /> Add Contract</a>
        ...
        <tr>
            <td>
                <div style="text-align: center;">
                    <?php if($rowData->payment_status == 0){ ?>
                    <a href="#" id="edit|po-pks|<?php echo $rowData->po_pks_id; ?>" role="button" title="Edit"><img src="assets/ico/gnome-edit.png" width="18px" height="18px" style="margin-bottom: 5px;" /></a>
          ...
          <td><?php echo $rowData->payment; ?></td>
					...
					<td><?php echo $rowData->final_status; ?></td>
        </tr>
        <?php

...
$sql = "SELECT con.*, cur.currency_code, v.vendor_name AS vendor_full, c.quantity AS quantity2,
			...
			DATE_FORMAT(con.entry_date, '%Y-%m') AS lock_date,
			CASE WHEN con.return_shipment = 1 THEN 'YES' ELSE 'NO' END AS returnShipment
        FROM contract con
		...
		AND con.langsir = 0
        ORDER BY con.contract_id DESC limit 3000
        ";
...
<a href="#addNew|contract" id="addNew" role="button"><img src="assets/ico/add.png" width="18px" height="18px" style="margin-bottom: 5px;" /> Add PO PKS</a>
